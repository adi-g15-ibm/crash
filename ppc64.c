...
void my_function(struct bt_info* bt, ulong nextsp) {
	uint64_t back_chain = *(uint64_t*)&bt->stackbuf[bt->frameptr + 0 - bt->stackbase];
	uint32_t cr_save_word = *(uint32_t*)&bt->stackbuf[bt->frameptr + 8 - bt->stackbase];
	uint32_t reserved = *(uint32_t*)&bt->stackbuf[bt->frameptr + 12 - bt->stackbase];
	uint64_t lr_save_dw = *(uint64_t*)&bt->stackbuf[bt->frameptr + 16 - bt->stackbase];
	uint64_t toc_ptr_dw = *(uint64_t*)&bt->stackbuf[bt->frameptr + 24 - bt->stackbase];
