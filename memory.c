...
static void kmem_cache_list_(struct meminfo *);
...
static int get_kmem_cache_list_(ulong **);
...
/*
 * Initialises the initinfo needed to initialise the lazy offsets on-demand
 */
void
lazy_offset_init(void)
{
	LAZY_INITINFO(RESIDUAL_VitalProductData, "RESIDUAL", "VitalProductData");
	LAZY_INITINFO(VPD_ProcessorHz, "VPD", "ProcessorHz");
	LAZY_INITINFO(__wait_queue_head_task_list, "__wait_queue_head", "task_list");
	LAZY_INITINFO(__wait_queue_task_list, "__wait_queue", "task_list");
	LAZY_INITINFO(array_cache_avail, "array_cache", "avail");
	LAZY_INITINFO(array_cache_limit, "array_cache", "limit");
	LAZY_INITINFO(atomic_t_counter, "atomic_t", "counter");
	LAZY_INITINFO(attribute_owner, "attribute", "owner");
	LAZY_INITINFO(bd_info_bi_intfreq, "bd_info", "bi_intfreq");
	LAZY_INITINFO(blk_major_name_major, "blk_major_name", "major");
	LAZY_INITINFO(blk_major_name_name, "blk_major_name", "name");
	LAZY_INITINFO(blk_major_name_next, "blk_major_name", "next");
	LAZY_INITINFO(blk_mq_ctx_rq_completed, "blk_mq_ctx", "rq_completed");
	LAZY_INITINFO(blk_mq_ctx_rq_dispatched, "blk_mq_ctx", "rq_dispatched");
	LAZY_INITINFO(blk_mq_hw_ctx_tags, "blk_mq_hw_ctx", "tags");
	LAZY_INITINFO(blk_mq_tags_bitmap_tags, "blk_mq_tags", "bitmap_tags");
	LAZY_INITINFO(blk_mq_tags_breserved_tags, "blk_mq_tags", "breserved_tags");
	LAZY_INITINFO(blk_mq_tags_nr_reserved_tags, "blk_mq_tags", "nr_reserved_tags");
	LAZY_INITINFO(blk_mq_tags_rqs, "blk_mq_tags", "rqs");
	LAZY_INITINFO(block_device_bd_device, "block_device", "bd_device");
	LAZY_INITINFO(block_device_bd_disk, "block_device", "bd_disk");
	LAZY_INITINFO(block_device_bd_inode, "block_device", "bd_inode");
	LAZY_INITINFO(block_device_bd_list, "block_device", "bd_list");
	LAZY_INITINFO(block_device_bd_stats, "block_device", "bd_stats");
	LAZY_INITINFO(bpf_map_key_size, "bpf_map", "key_size");
	LAZY_INITINFO(bpf_map_map_flags, "bpf_map", "map_flags");
	LAZY_INITINFO(bpf_map_map_type, "bpf_map", "map_type");
	LAZY_INITINFO(bpf_map_max_entries, "bpf_map", "max_entries");
	LAZY_INITINFO(bpf_map_memory, "bpf_map", "memory");
	LAZY_INITINFO(bpf_map_memory_pages, "bpf_map_memory", "pages");
	LAZY_INITINFO(bpf_map_memory_user, "bpf_map_memory", "user");
	LAZY_INITINFO(bpf_map_name, "bpf_map", "name");
	LAZY_INITINFO(bpf_map_pages, "bpf_map", "pages");
	LAZY_INITINFO(bpf_map_user, "bpf_map", "user");
	LAZY_INITINFO(bpf_map_value_size, "bpf_map", "value_size");
	LAZY_INITINFO(bpf_prog_aux, "bpf_prog", "aux");
	LAZY_INITINFO(bpf_prog_aux_load_time, "bpf_prog_aux", "load_time");
	LAZY_INITINFO(bpf_prog_aux_name, "bpf_prog_aux", "name");
	LAZY_INITINFO(bpf_prog_aux_used_map_cnt, "bpf_prog_aux", "used_map_cnt");
	LAZY_INITINFO(bpf_prog_aux_used_maps, "bpf_prog_aux", "used_maps");
	LAZY_INITINFO(bpf_prog_aux_user, "bpf_prog_aux", "user");
	LAZY_INITINFO(bpf_prog_bpf_func, "bpf_prog", "bpf_func");
	LAZY_INITINFO(bpf_prog_insnsi, "bpf_prog", "insnsi");
	LAZY_INITINFO(bpf_prog_jited_len, "bpf_prog", "jited_len");
	LAZY_INITINFO(bpf_prog_len, "bpf_prog", "len");
	LAZY_INITINFO(bpf_prog_pages, "bpf_prog", "pages");
	LAZY_INITINFO(bpf_prog_tag, "bpf_prog", "tag");
	LAZY_INITINFO(bpf_prog_type, "bpf_prog", "type");
	LAZY_INITINFO(bus_type_p, "bus_type", "p");
	LAZY_INITINFO(cdev_ops, "cdev", "ops");
	LAZY_INITINFO(cfs_rq_curr, "cfs_rq", "curr");
	LAZY_INITINFO(cfs_rq_nr_running, "cfs_rq", "nr_running");
	LAZY_INITINFO(cfs_rq_tasks_timeline, "cfs_rq", "tasks_timeline");
	LAZY_INITINFO(cfs_rq_tg, "cfs_rq", "tg");
	LAZY_INITINFO(cfs_rq_throttled, "cfs_rq", "throttled");
	LAZY_INITINFO(cgroup_dentry, "cgroup", "dentry");
	LAZY_INITINFO(cgroup_kn, "cgroup", "kn");
	LAZY_INITINFO(cgroup_subsys_state_cgroup, "cgroup_subsys_state", "cgroup");
	LAZY_INITINFO(char_device_struct_baseminor, "char_device_struct", "baseminor");
	LAZY_INITINFO(char_device_struct_cdev, "char_device_struct", "cdev");
	LAZY_INITINFO(char_device_struct_fops, "char_device_struct", "fops");
	LAZY_INITINFO(char_device_struct_major, "char_device_struct", "major");
	LAZY_INITINFO(char_device_struct_name, "char_device_struct", "name");
	LAZY_INITINFO(char_device_struct_next, "char_device_struct", "next");
	LAZY_INITINFO(class_p, "class", "p");
	LAZY_INITINFO(class_private_devices, "class_private", "class_devices");
	LAZY_INITINFO(cpu_context_save_fp, "cpu_context_save", "fp");
	LAZY_INITINFO(cpu_context_save_pc, "cpu_context_save", "pc");
	LAZY_INITINFO(cpu_context_save_r7, "cpu_context_save", "r7");
	LAZY_INITINFO(cpu_context_save_sp, "cpu_context_save", "sp");
	LAZY_INITINFO(cpu_s_curr, "cpu_s", "curr");
	LAZY_INITINFO(cpu_s_idle, "cpu_s", "idle");
	LAZY_INITINFO(cpu_user_regs_eip, "cpu_user_regs", "eip");
	LAZY_INITINFO(cpu_user_regs_esp, "cpu_user_regs", "esp");
	LAZY_INITINFO(cpucache_s_avail, "cpucache_s", "avail");
	LAZY_INITINFO(cpucache_s_limit, "cpucache_s", "limit");
	LAZY_INITINFO(cpuinfo_ia64_proc_freq, "cpuinfo_ia64", "proc_freq");
	LAZY_INITINFO(cpuinfo_ia64_unimpl_pa_mask, "cpuinfo_ia64", "unimpl_pa_mask");
	LAZY_INITINFO(cpuinfo_ia64_unimpl_va_mask, "cpuinfo_ia64", "unimpl_va_mask");
	LAZY_INITINFO(dentry_d_covers, "dentry", "d_covers");
	LAZY_INITINFO(dentry_d_iname, "dentry", "d_iname");
	LAZY_INITINFO(dentry_d_inode, "dentry", "d_inode");
	LAZY_INITINFO(dentry_d_name, "dentry", "d_name");
	LAZY_INITINFO(dentry_d_parent, "dentry", "d_parent");
	LAZY_INITINFO(dentry_d_sb, "dentry", "d_sb");
	LAZY_INITINFO(device_addr_len, "device", "addr_len");
	LAZY_INITINFO(device_ip_ptr, "device", "ip_ptr");
	LAZY_INITINFO(device_knode_class, "device", "knode_class");
	LAZY_INITINFO(device_kobj, "device", "kobj");
	LAZY_INITINFO(device_name, "device", "name");
	LAZY_INITINFO(device_next, "device", "next");
	LAZY_INITINFO(device_node, "device", "node");
	LAZY_INITINFO(device_node_allnext, "device_node", "allnext");
	LAZY_INITINFO(device_node_properties, "device_node", "properties");
	LAZY_INITINFO(device_node_type, "device_node", "type");
	LAZY_INITINFO(device_private_device, "device_private", "device");
	LAZY_INITINFO(device_private_knode_bus, "device_private", "knode_bus");
	LAZY_INITINFO(device_private_knode_class, "device_private", "knode_class");
	LAZY_INITINFO(device_type, "device", "type");
	LAZY_INITINFO(disk_stats_in_flight, "disk_stats", "in_flight");
	LAZY_INITINFO(elf_prstatus_pr_pid, "elf_prstatus", "pr_pid");
	LAZY_INITINFO(elf_prstatus_pr_reg, "elf_prstatus", "pr_reg");
	LAZY_INITINFO(fdtable_fd, "fdtable", "fd");
	LAZY_INITINFO(fdtable_max_fds, "fdtable", "max_fds");
	LAZY_INITINFO(fdtable_max_fdset, "fdtable", "max_fdset");
	LAZY_INITINFO(fdtable_open_fds, "fdtable", "open_fds");
	LAZY_INITINFO(file_f_count, "file", "f_count");
	LAZY_INITINFO(file_f_op, "file", "f_op");
	LAZY_INITINFO(file_f_path, "file", "f_path");
	LAZY_INITINFO(file_lock_fl_owner, "file_lock", "fl_owner");
	LAZY_INITINFO(file_private_data, "file", "private_data");
	LAZY_INITINFO(file_system_type_name, "file_system_type", "name");
	LAZY_INITINFO(files_struct_fd, "files_struct", "fd");
	LAZY_INITINFO(files_struct_fdt, "files_struct", "fdt");
	LAZY_INITINFO(files_struct_max_fds, "files_struct", "max_fds");
	LAZY_INITINFO(files_struct_max_fdset, "files_struct", "max_fdset");
	LAZY_INITINFO(files_struct_open_fds, "files_struct", "open_fds");
	LAZY_INITINFO(files_struct_open_fds_init, "files_struct", "open_fds_init");
	LAZY_INITINFO(fs_struct_pwd, "fs_struct", "pwd");
	LAZY_INITINFO(fs_struct_pwdmnt, "fs_struct", "pwdmnt");
	LAZY_INITINFO(fs_struct_root, "fs_struct", "root");
	LAZY_INITINFO(fs_struct_rootmnt, "fs_struct", "rootmnt");
	LAZY_INITINFO(gendisk_disk_name, "gendisk", "disk_name");
	LAZY_INITINFO(gendisk_fops, "gendisk", "fops");
	LAZY_INITINFO(gendisk_kobj, "gendisk", "kobj");
	LAZY_INITINFO(gendisk_major, "gendisk", "major");
	LAZY_INITINFO(gendisk_part0, "gendisk", "part0");
	LAZY_INITINFO(gendisk_private_data, "gendisk", "private_data");
	LAZY_INITINFO(gendisk_queue, "gendisk", "queue");
	LAZY_INITINFO(hd_struct_dev, "hd_struct", "__dev");
	LAZY_INITINFO(hd_struct_dkstats, "hd_struct", "dkstats");
	LAZY_INITINFO(hlist_node_next, "hlist_node", "next");
	LAZY_INITINFO(hlist_node_pprev, "hlist_node", "pprev");
	LAZY_INITINFO(hrtimer_base_first, "hrtimer_base", "first");
	LAZY_INITINFO(hrtimer_base_get_time, "hrtimer_base", "get_time");
	LAZY_INITINFO(hrtimer_base_pending, "hrtimer_base", "pending");
	LAZY_INITINFO(hrtimer_clock_base_active, "hrtimer_clock_base", "active");
	LAZY_INITINFO(hrtimer_clock_base_first, "hrtimer_clock_base", "first");
	LAZY_INITINFO(hrtimer_clock_base_get_time, "hrtimer_clock_base", "get_time");
	LAZY_INITINFO(hrtimer_clock_base_offset, "hrtimer_clock_base", "offset");
	LAZY_INITINFO(hrtimer_cpu_base_clock_base, "hrtimer_cpu_base", "clock_base");
	LAZY_INITINFO(hrtimer_function, "hrtimer", "function");
	LAZY_INITINFO(hrtimer_list, "hrtimer", "list");
	LAZY_INITINFO(hrtimer_node, "hrtimer", "node");
	LAZY_INITINFO(hrtimer_softexpires, "hrtimer", "_softexpires");
	LAZY_INITINFO(hstate_free_huge_pages, "hstate", "free_huge_pages");
	LAZY_INITINFO(hstate_name, "hstate", "name");
	LAZY_INITINFO(hstate_nr_huge_pages, "hstate", "nr_huge_pages");
	LAZY_INITINFO(hstate_order, "hstate", "order");
	LAZY_INITINFO(hugetlbfs_sb_info_hstate, "hugetlbfs_sb_info", "hstate");
	LAZY_INITINFO(hw_interrupt_type_ack, "hw_interrupt_type", "ack");
	LAZY_INITINFO(hw_interrupt_type_disable, "hw_interrupt_type", "disable");
	LAZY_INITINFO(hw_interrupt_type_enable, "hw_interrupt_type", "enable");
	LAZY_INITINFO(hw_interrupt_type_end, "hw_interrupt_type", "end");
	LAZY_INITINFO(hw_interrupt_type_handle, "hw_interrupt_type", "handle");
	LAZY_INITINFO(hw_interrupt_type_set_affinity, "hw_interrupt_type", "set_affinity");
	LAZY_INITINFO(hw_interrupt_type_shutdown, "hw_interrupt_type", "shutdown");
	LAZY_INITINFO(hw_interrupt_type_startup, "hw_interrupt_type", "startup");
	LAZY_INITINFO(hw_interrupt_type_typename, "hw_interrupt_type", "typename");
	LAZY_INITINFO(hwrpb_struct_cycle_freq, "hwrpb_struct", "cycle_freq");
	LAZY_INITINFO(hwrpb_struct_processor_offset, "hwrpb_struct", "processor_offset");
	LAZY_INITINFO(hwrpb_struct_processor_size, "hwrpb_struct", "processor_size");
	LAZY_INITINFO(idr_cur, "idr", "cur");
	LAZY_INITINFO(idr_idr_rt, "idr", "idr_rt");
	LAZY_INITINFO(idr_layer_ary, "idr_layer", "ary");
	LAZY_INITINFO(idr_layer_layer, "idr_layer", "layer");
	LAZY_INITINFO(idr_layers, "idr", "layers");
	LAZY_INITINFO(idr_top, "idr", "top");
	LAZY_INITINFO(in6_addr_in6_u, "in6_addr", "in6_u");
	LAZY_INITINFO(in_device_ifa_list, "in_device", "ifa_list");
	LAZY_INITINFO(in_ifaddr_ifa_address, "in_ifaddr", "ifa_address");
	LAZY_INITINFO(in_ifaddr_ifa_next, "in_ifaddr", "ifa_next");
	LAZY_INITINFO(inactive_task_frame_bp, "inactive_task_frame", "bp");
	LAZY_INITINFO(inactive_task_frame_ret_addr, "inactive_task_frame", "ret_addr");
	LAZY_INITINFO(inet6_dev_addr_list, "inet6_dev", "addr_list");
	LAZY_INITINFO(inet6_ifaddr_addr, "inet6_ifaddr", "addr");
	LAZY_INITINFO(inet6_ifaddr_if_list, "inet6_ifaddr", "if_list");
	LAZY_INITINFO(inet6_ifaddr_if_next, "inet6_ifaddr", "if_next");
	LAZY_INITINFO(inode_i_flock, "inode", "i_flock");
	LAZY_INITINFO(inode_i_fop, "inode", "i_fop");
	LAZY_INITINFO(inode_i_mapping, "inode", "i_mapping");
	LAZY_INITINFO(inode_i_mode, "inode", "i_mode");
	LAZY_INITINFO(inode_i_op, "inode", "i_op");
	LAZY_INITINFO(inode_i_sb, "inode", "i_sb");
	LAZY_INITINFO(inode_i_sb_list, "inode", "i_sb_list");
	LAZY_INITINFO(inode_u, "inode", "u");
	LAZY_INITINFO(ipc_id_ary_p, "ipc_id_ary", "p");
	LAZY_INITINFO(ipc_ids_entries, "ipc_ids", "entries");
	LAZY_INITINFO(ipc_ids_in_use, "ipc_ids", "in_use");
	LAZY_INITINFO(ipc_ids_ipcs_idr, "ipc_ids", "ipcs_idr");
	LAZY_INITINFO(ipc_ids_max_id, "ipc_ids", "max_id");
	LAZY_INITINFO(ipc_namespace_ids, "ipc_namespace", "ids");
	LAZY_INITINFO(ipv6_pinfo_daddr, "ipv6_pinfo", "daddr");
	LAZY_INITINFO(ipv6_pinfo_rcv_saddr, "ipv6_pinfo", "rcv_saddr");
	LAZY_INITINFO(irq_chip_ack, "irq_chip", "ack");
	LAZY_INITINFO(irq_chip_disable, "irq_chip", "disable");
	LAZY_INITINFO(irq_chip_enable, "irq_chip", "enable");
	LAZY_INITINFO(irq_chip_end, "irq_chip", "end");
	LAZY_INITINFO(irq_chip_eoi, "irq_chip", "eoi");
	LAZY_INITINFO(irq_chip_mask, "irq_chip", "mask");
	LAZY_INITINFO(irq_chip_mask_ack, "irq_chip", "mask_ack");
	LAZY_INITINFO(irq_chip_retrigger, "irq_chip", "retrigger");
	LAZY_INITINFO(irq_chip_set_affinity, "irq_chip", "set_affinity");
	LAZY_INITINFO(irq_chip_set_type, "irq_chip", "set_type");
	LAZY_INITINFO(irq_chip_set_wake, "irq_chip", "set_wake");
	LAZY_INITINFO(irq_chip_shutdown, "irq_chip", "shutdown");
	LAZY_INITINFO(irq_chip_startup, "irq_chip", "startup");
	LAZY_INITINFO(irq_chip_typename, "irq_chip", "name");
	LAZY_INITINFO(irq_chip_unmask, "irq_chip", "unmask");
	LAZY_INITINFO(irq_common_data_affinity, "irq_common_data", "affinity");
	LAZY_INITINFO(irq_cpustat_t___softirq_active, "irq_cpustat_t", "__softirq_active");
	LAZY_INITINFO(irq_cpustat_t___softirq_mask, "irq_cpustat_t", "__softirq_mask");
	LAZY_INITINFO(irq_data_affinity, "irq_data", "affinity");
	LAZY_INITINFO(irq_data_chip, "irq_data", "chip");
	LAZY_INITINFO(irq_desc_irq_common_data, "irq_desc", "irq_common_data");
	LAZY_INITINFO(irq_desc_irq_data, "irq_desc", "irq_data");
	LAZY_INITINFO(irqaction_dev_id, "irqaction", "dev_id");
	LAZY_INITINFO(irqaction_flags, "irqaction", "flags");
	LAZY_INITINFO(irqaction_handler, "irqaction", "handler");
	LAZY_INITINFO(irqaction_mask, "irqaction", "mask");
	LAZY_INITINFO(irqaction_name, "irqaction", "name");
	LAZY_INITINFO(irqaction_next, "irqaction", "next");
	LAZY_INITINFO(irqdesc_action, "irqdesc", "action");
	LAZY_INITINFO(irqdesc_ctl, "irqdesc", "ctl");
	LAZY_INITINFO(irqdesc_level, "irqdesc", "level");
	LAZY_INITINFO(k_sigaction_sa, "k_sigaction", "sa");
	LAZY_INITINFO(kallsyms_header_section_off, "kallsyms_header", "section_off");
	LAZY_INITINFO(kallsyms_header_sections, "kallsyms_header", "sections");
	LAZY_INITINFO(kallsyms_header_string_off, "kallsyms_header", "string_off");
	LAZY_INITINFO(kallsyms_header_symbol_off, "kallsyms_header", "symbol_off");
	LAZY_INITINFO(kallsyms_header_symbols, "kallsyms_header", "symbols");
	LAZY_INITINFO(kallsyms_section_name_off, "kallsyms_section", "name_off");
	LAZY_INITINFO(kallsyms_section_size, "kallsyms_section", "size");
	LAZY_INITINFO(kallsyms_section_start, "kallsyms_section", "start");
	LAZY_INITINFO(kallsyms_symbol_name_off, "kallsyms_symbol", "name_off");
	LAZY_INITINFO(kallsyms_symbol_section_off, "kallsyms_symbol", "section_off");
	LAZY_INITINFO(kallsyms_symbol_symbol_addr, "kallsyms_symbol", "symbol_addr");
	LAZY_INITINFO(kern_ipc_perm_deleted, "kern_ipc_perm", "deleted");
	LAZY_INITINFO(kern_ipc_perm_id, "kern_ipc_perm", "id");
	LAZY_INITINFO(kern_ipc_perm_key, "kern_ipc_perm", "key");
	LAZY_INITINFO(kern_ipc_perm_mode, "kern_ipc_perm", "mode");
	LAZY_INITINFO(kern_ipc_perm_seq, "kern_ipc_perm", "seq");
	LAZY_INITINFO(kern_ipc_perm_uid, "kern_ipc_perm", "uid");
	LAZY_INITINFO(kernel_stat_irqs, "kernel_stat", "irqs");
	LAZY_INITINFO(kernfs_node_name, "kernfs_node", "name");
	LAZY_INITINFO(kernfs_node_parent, "kernfs_node", "parent");
	LAZY_INITINFO(klist_k_list, "klist", "k_list");
	LAZY_INITINFO(klist_node_n_klist, "klist_node", "n_klist");
	LAZY_INITINFO(klist_node_n_node, "klist_node", "n_node");
	LAZY_INITINFO(kmem_cache_align, "kmem_cache", "align");
	LAZY_INITINFO(kmem_cache_cpu_cache, "kmem_cache", "cpu_cache");
	LAZY_INITINFO(kmem_cache_cpu_freelist, "kmem_cache_cpu", "freelist");
	LAZY_INITINFO(kmem_cache_cpu_node, "kmem_cache_cpu", "node");
	LAZY_INITINFO(kmem_cache_cpu_partial, "kmem_cache_cpu", "partial");
	LAZY_INITINFO(kmem_cache_cpu_slab, "kmem_cache", "cpu_slab");
	LAZY_INITINFO(kmem_cache_flags, "kmem_cache", "flags");
	LAZY_INITINFO(kmem_cache_inuse, "kmem_cache", "inuse");
	LAZY_INITINFO(kmem_cache_list, "kmem_cache", "list");
	LAZY_INITINFO(kmem_cache_local_node, "kmem_cache", "local_node");
	LAZY_INITINFO(kmem_cache_memcg_params, "kmem_cache", "memcg_params");
	LAZY_INITINFO(kmem_cache_name, "kmem_cache", "name");
	LAZY_INITINFO(kmem_cache_node, "kmem_cache", "node");
	LAZY_INITINFO(kmem_cache_node_full, "kmem_cache_node", "full");
	LAZY_INITINFO(kmem_cache_node_nr_partial, "kmem_cache_node", "nr_partial");
	LAZY_INITINFO(kmem_cache_node_nr_slabs, "kmem_cache_node", "nr_slabs");
	LAZY_INITINFO(kmem_cache_node_partial, "kmem_cache_node", "partial");
	LAZY_INITINFO(kmem_cache_node_total_objects, "kmem_cache_node", "total_objects");
	LAZY_INITINFO(kmem_cache_objects, "kmem_cache", "objects");
	LAZY_INITINFO(kmem_cache_offset, "kmem_cache", "offset");
	LAZY_INITINFO(kmem_cache_oo, "kmem_cache", "oo");
	LAZY_INITINFO(kmem_cache_order, "kmem_cache", "order");
	LAZY_INITINFO(kmem_cache_random, "kmem_cache", "random");
	LAZY_INITINFO(kmem_cache_red_left_pad, "kmem_cache", "red_left_pad");
	LAZY_INITINFO(kmem_cache_s_c_align, "kmem_cache_s", "c_align");
	LAZY_INITINFO(kmem_cache_s_c_firstp, "kmem_cache_s", "c_firstp");
	LAZY_INITINFO(kmem_cache_s_c_flags, "kmem_cache_s", "c_flags");
	LAZY_INITINFO(kmem_cache_s_c_gfporder, "kmem_cache_s", "c_gfporder");
	LAZY_INITINFO(kmem_cache_s_c_magic, "kmem_cache_s", "c_magic");
	LAZY_INITINFO(kmem_cache_s_c_name, "kmem_cache_s", "c_name");
	LAZY_INITINFO(kmem_cache_s_c_nextp, "kmem_cache_s", "c_nextp");
	LAZY_INITINFO(kmem_cache_s_c_num, "kmem_cache_s", "c_num");
	LAZY_INITINFO(kmem_cache_s_c_offset, "kmem_cache_s", "c_offset");
	LAZY_INITINFO(kmem_cache_s_c_org_size, "kmem_cache_s", "c_org_size");
	LAZY_INITINFO(kmem_cache_s_cpudata, "kmem_cache_s", "cpudata");
	LAZY_INITINFO(kmem_cache_s_slabs, "kmem_cache_s", "slabs");
	LAZY_INITINFO(kmem_cache_s_slabs_free, "kmem_cache_s", "slabs_free");
	LAZY_INITINFO(kmem_cache_s_slabs_full, "kmem_cache_s", "slabs_full");
	LAZY_INITINFO(kmem_cache_s_slabs_partial, "kmem_cache_s", "slabs_partial");
	LAZY_INITINFO(kmem_cache_size, "kmem_cache", "size");
	LAZY_INITINFO(kmem_slab_s_s_freep, "kmem_slab_s", "s_freep");
	LAZY_INITINFO(kmem_slab_s_s_index, "kmem_slab_s", "s_index");
	LAZY_INITINFO(kmem_slab_s_s_inuse, "kmem_slab_s", "s_inuse");
	LAZY_INITINFO(kmem_slab_s_s_magic, "kmem_slab_s", "s_magic");
	LAZY_INITINFO(kmem_slab_s_s_mem, "kmem_slab_s", "s_mem");
	LAZY_INITINFO(kmem_slab_s_s_nextp, "kmem_slab_s", "s_nextp");
	LAZY_INITINFO(kmem_slab_s_s_offset, "kmem_slab_s", "s_offset");
	LAZY_INITINFO(kobj_map_probes, "kobj_map", "probes");
	LAZY_INITINFO(kobject_entry, "kobject", "entry");
	LAZY_INITINFO(kobject_name, "kobject", "name");
	LAZY_INITINFO(kset_kobj, "kset", "kobj");
	LAZY_INITINFO(kset_list, "kset", "list");
	LAZY_INITINFO(list_head_next, "list_head", "next");
	LAZY_INITINFO(list_head_prev, "list_head", "prev");
	LAZY_INITINFO(machdep_calls_setup_residual, "machdep_calls", "setup_residual");
	LAZY_INITINFO(maple_arange_64_gap, "maple_arange_64", "gap");
	LAZY_INITINFO(maple_arange_64_meta, "maple_arange_64", "meta");
	LAZY_INITINFO(maple_arange_64_pivot, "maple_arange_64", "pivot");
	LAZY_INITINFO(maple_arange_64_slot, "maple_arange_64", "slot");
	LAZY_INITINFO(maple_metadata_end, "maple_metadata", "end");
	LAZY_INITINFO(maple_metadata_gap, "maple_metadata", "gap");
	LAZY_INITINFO(maple_node_ma64, "maple_node", "ma64");
	LAZY_INITINFO(maple_node_mr64, "maple_node", "mr64");
	LAZY_INITINFO(maple_node_parent, "maple_node", "parent");
	LAZY_INITINFO(maple_node_slot, "maple_node", "slot");
	LAZY_INITINFO(maple_range_64_pivot, "maple_range_64", "pivot");
	LAZY_INITINFO(maple_range_64_slot, "maple_range_64", "slot");
	LAZY_INITINFO(maple_tree_ma_flags, "maple_tree", "ma_flags");
	LAZY_INITINFO(maple_tree_ma_root, "maple_tree", "ma_root");
	LAZY_INITINFO(mem_section_section_mem_map, "mem_section", "section_mem_map");
	LAZY_INITINFO(memcg_cache_params___root_caches_node, "memcg_cache_params", "__root_caches_node");
	LAZY_INITINFO(memcg_cache_params_children, "memcg_cache_params", "children");
	LAZY_INITINFO(memcg_cache_params_children_node, "memcg_cache_params", "children_node");
	LAZY_INITINFO(memory_block_dev, "memory_block", "dev");
	LAZY_INITINFO(memory_block_end_section_nr, "memory_block", "end_section_nr");
	LAZY_INITINFO(memory_block_nid, "memory_block", "nid");
	LAZY_INITINFO(memory_block_start_section_nr, "memory_block", "start_section_nr");
	LAZY_INITINFO(memory_block_state, "memory_block", "state");
	LAZY_INITINFO(mm_rss_stat_count, "mm_rss_stat", "count");
	LAZY_INITINFO(mm_struct_anon_rss, "mm_struct", "_anon_rss");
	LAZY_INITINFO(mm_struct_arg_end, "mm_struct", "arg_end");
	LAZY_INITINFO(mm_struct_arg_start, "mm_struct", "arg_start");
	LAZY_INITINFO(mm_struct_env_end, "mm_struct", "env_end");
	LAZY_INITINFO(mm_struct_env_start, "mm_struct", "env_start");
	LAZY_INITINFO(mm_struct_file_rss, "mm_struct", "_file_rss");
	LAZY_INITINFO(mm_struct_mm_count, "mm_struct", "mm_count");
	LAZY_INITINFO(mm_struct_mm_mt, "mm_struct", "mm_mt");
	LAZY_INITINFO(mm_struct_mmap, "mm_struct", "mmap");
	LAZY_INITINFO(mm_struct_pgd, "mm_struct", "pgd");
	LAZY_INITINFO(mm_struct_rss_stat, "mm_struct", "rss_stat");
	LAZY_INITINFO(mm_struct_start_code, "mm_struct", "start_code");
	LAZY_INITINFO(mm_struct_total_vm, "mm_struct", "total_vm");
	LAZY_INITINFO(mnt_namespace_list, "mnt_namespace", "list");
	LAZY_INITINFO(mnt_namespace_root, "mnt_namespace", "root");
	LAZY_INITINFO(mod_arch_specific_num_orcs, "mod_arch_specific", "num_orcs");
	LAZY_INITINFO(mod_arch_specific_orc_unwind, "mod_arch_specific", "orc_unwind");
	LAZY_INITINFO(mod_arch_specific_orc_unwind_ip, "mod_arch_specific", "orc_unwind_ip");
	LAZY_INITINFO(module_arch, "module", "arch");
	LAZY_INITINFO(module_attribute_attr, "module_attribute", "attr");
	LAZY_INITINFO(module_flags, "module", "flags");
	LAZY_INITINFO(module_gpgsig_ok, "module", "gpgsig_ok");
	LAZY_INITINFO(module_gpl_syms, "module", "gpl_syms");
	LAZY_INITINFO(module_kallsyms_start, "module", "kallsyms_start");
	LAZY_INITINFO(module_license_gplok, "module", "license_gplok");
	LAZY_INITINFO(module_list, "module", "list");
	LAZY_INITINFO(module_name, "module", "name");
	LAZY_INITINFO(module_next, "module", "next");
	LAZY_INITINFO(module_nsyms, "module", "nsyms");
	LAZY_INITINFO(module_num_gpl_syms, "module", "num_gpl_syms");
	LAZY_INITINFO(module_num_syms, "module", "num_syms");
	LAZY_INITINFO(module_percpu, "module", "percpu");
	LAZY_INITINFO(module_sect_attr_address, "module_sect_attr", "address");
	LAZY_INITINFO(module_sect_attr_attr, "module_sect_attr", "attr");
	LAZY_INITINFO(module_sect_attr_mattr, "module_sect_attr", "mattr");
	LAZY_INITINFO(module_sect_attr_name, "module_sect_attr", "name");
	LAZY_INITINFO(module_sect_attrs, "module", "sect_attrs");
	LAZY_INITINFO(module_sect_attrs_attrs, "module_sect_attrs", "attrs");
	LAZY_INITINFO(module_sect_attrs_nsections, "module_sect_attrs", "nsections");
	LAZY_INITINFO(module_sections_attrs, "module_sections", "attrs");
	LAZY_INITINFO(module_size, "module", "size");
	LAZY_INITINFO(module_size_of_struct, "module", "size_of_struct");
	LAZY_INITINFO(module_syms, "module", "syms");
	LAZY_INITINFO(module_taints, "module", "taints");
	LAZY_INITINFO(mount_mnt, "mount", "mnt");
	LAZY_INITINFO(mount_mnt_devname, "mount", "mnt_devname");
	LAZY_INITINFO(mount_mnt_list, "mount", "mnt_list");
	LAZY_INITINFO(mount_mnt_mountpoint, "mount", "mnt_mountpoint");
	LAZY_INITINFO(mount_mnt_parent, "mount", "mnt_parent");
	LAZY_INITINFO(msg_queue_q_cbytes, "msg_queue", "q_cbytes");
	LAZY_INITINFO(msg_queue_q_id, "msg_queue", "q_id");
	LAZY_INITINFO(msg_queue_q_perm, "msg_queue", "q_perm");
	LAZY_INITINFO(msg_queue_q_qnum, "msg_queue", "q_qnum");
	LAZY_INITINFO(neigh_table_hash_shift, "neigh_hash_table", "hash_shift");
	LAZY_INITINFO(neigh_table_key_len, "neigh_table", "key_len");
	LAZY_INITINFO(neigh_table_nht_ptr, "neigh_table", "nht");
	LAZY_INITINFO(neighbour_dev, "neighbour", "dev");
	LAZY_INITINFO(neighbour_ha, "neighbour", "ha");
	LAZY_INITINFO(neighbour_next, "neighbour", "next");
	LAZY_INITINFO(neighbour_nud_state, "neighbour", "nud_state");
	LAZY_INITINFO(neighbour_primary_key, "neighbour", "primary_key");
	LAZY_INITINFO(net_dev_base_head, "net", "dev_base_head");
	LAZY_INITINFO(net_device_addr_len, "net_device", "addr_len");
	LAZY_INITINFO(net_device_dev_list, "net_device", "dev_list");
	LAZY_INITINFO(net_device_ip6_ptr, "net_device", "ip6_ptr");
	LAZY_INITINFO(net_device_ip_ptr, "net_device", "ip_ptr");
	LAZY_INITINFO(net_device_name, "net_device", "name");
	LAZY_INITINFO(net_device_next, "net_device", "next");
	LAZY_INITINFO(net_device_type, "net_device", "type");
	LAZY_INITINFO(nlm_file_f_file, "nlm_file", "f_file");
	LAZY_INITINFO(nlm_host_h_exportent, "nlm_host", "h_exportent");
	LAZY_INITINFO(nlmsghdr_nlmsg_type, "nlmsghdr", "nlmsg_type");
	LAZY_INITINFO(nsproxy_ipc_ns, "nsproxy", "ipc_ns");
	LAZY_INITINFO(nsproxy_mnt_ns, "nsproxy", "mnt_ns");
	LAZY_INITINFO(nsproxy_net_ns, "nsproxy", "net_ns");
	LAZY_INITINFO(page_buffers, "page", "buffers");
	LAZY_INITINFO(page_cache_bucket_chain, "page_cache_bucket", "chain");
	LAZY_INITINFO(page_flags, "page", "flags");
	LAZY_INITINFO(page_inode, "page", "inode");
	LAZY_INITINFO(page_list, "page", "list");
	LAZY_INITINFO(page_next_hash, "page", "next_hash");
	LAZY_INITINFO(page_prev, "page", "prev");
	LAZY_INITINFO(page_private, "page", "private");
	LAZY_INITINFO(page_pte, "page", "pte");
	LAZY_INITINFO(path_dentry, "path", "dentry");
	LAZY_INITINFO(path_mnt, "path", "mnt");
	LAZY_INITINFO(pci_bus_children, "pci_bus", "children");
	LAZY_INITINFO(pci_bus_dev, "pci_bus", "dev");
	LAZY_INITINFO(pci_bus_devices, "pci_bus", "devices");
	LAZY_INITINFO(pci_bus_node, "pci_bus", "node");
	LAZY_INITINFO(pci_bus_number, "pci_bus", "number");
	LAZY_INITINFO(pci_bus_parent, "pci_bus", "parent");
	LAZY_INITINFO(pci_bus_self, "pci_bus", "self");
	LAZY_INITINFO(pci_dev_bus, "pci_dev", "bus");
	LAZY_INITINFO(pci_dev_class, "pci_dev", "class");
	LAZY_INITINFO(pci_dev_dev, "pci_dev", "dev");
	LAZY_INITINFO(pci_dev_devfn, "pci_dev", "devfn");
	LAZY_INITINFO(pci_dev_device, "pci_dev", "device");
	LAZY_INITINFO(pci_dev_global_list, "pci_dev", "global_list");
	LAZY_INITINFO(pci_dev_hdr_type, "pci_dev", "hdr_type");
	LAZY_INITINFO(pci_dev_next, "pci_dev", "next");
	LAZY_INITINFO(pci_dev_pcie_flags_reg, "pci_dev", "pcie_flags_reg");
	LAZY_INITINFO(pci_dev_vendor, "pci_dev", "vendor");
	LAZY_INITINFO(pcpu_info_idle, "pcpu_info", "idle");
	LAZY_INITINFO(pcpu_info_vcpu, "pcpu_info", "vcpu");
	LAZY_INITINFO(percpu_counter_count, "percpu_counter", "count");
	LAZY_INITINFO(percpu_counter_counters, "percpu_counter", "counters");
	LAZY_INITINFO(percpu_struct_halt_PC, "percpu_struct", "halt_PC");
	LAZY_INITINFO(percpu_struct_halt_pv, "percpu_struct", "halt_pv");
	LAZY_INITINFO(percpu_struct_halt_ra, "percpu_struct", "halt_ra");
	LAZY_INITINFO(pglist_data_bdata, "pglist_data", "bdata");
	LAZY_INITINFO(pglist_data_node_id, "pglist_data", "node_id");
	LAZY_INITINFO(pglist_data_node_mem_map, "pglist_data", "node_mem_map");
	LAZY_INITINFO(pglist_data_node_next, "pglist_data", "node_next");
	LAZY_INITINFO(pglist_data_node_present_pages, "pglist_data", "node_present_pages");
	LAZY_INITINFO(pglist_data_node_size, "pglist_data", "node_size");
	LAZY_INITINFO(pglist_data_node_spanned_pages, "pglist_data", "node_spanned_pages");
	LAZY_INITINFO(pglist_data_node_start_mapnr, "pglist_data", "node_start_mapnr");
	LAZY_INITINFO(pglist_data_node_start_paddr, "pglist_data", "node_start_paddr");
	LAZY_INITINFO(pglist_data_node_start_pfn, "pglist_data", "node_start_pfn");
	LAZY_INITINFO(pglist_data_node_zones, "pglist_data", "node_zones");
	LAZY_INITINFO(pglist_data_nr_zones, "pglist_data", "nr_zones");
	LAZY_INITINFO(pglist_data_pgdat_next, "pglist_data", "pgdat_next");
	LAZY_INITINFO(pid_hash_chain, "pid", "hash_chain");
	LAZY_INITINFO(pid_link_pid, "pid_link", "pid");
	LAZY_INITINFO(pid_namespace_idr, "pid_namespace", "idr");
	LAZY_INITINFO(pid_numbers, "pid", "numbers");
	LAZY_INITINFO(pid_pid_chain, "pid", "pid_chain");
	LAZY_INITINFO(pid_tasks, "pid", "tasks");
	LAZY_INITINFO(printk_safe_seq_buf_buffer, "printk_safe_seq_buf", "buffer");
	LAZY_INITINFO(printk_safe_seq_buf_len, "printk_safe_seq_buf", "len");
	LAZY_INITINFO(printk_safe_seq_buf_message_lost, "printk_safe_seq_buf", "message_lost");
	LAZY_INITINFO(prio_array_nr_active, "prio_array", "nr_active");
	LAZY_INITINFO(prio_array_queue, "prio_array", "queue");
	LAZY_INITINFO(probe_data, "probe", "data");
	LAZY_INITINFO(probe_dev, "probe", "dev");
	LAZY_INITINFO(probe_next, "probe", "next");
	LAZY_INITINFO(property_name, "property", "name");
	LAZY_INITINFO(property_next, "property", "next");
	LAZY_INITINFO(property_value, "property", "value");
	LAZY_INITINFO(pt_regs_cp0_badvaddr, "pt_regs", "cp0_badvaddr");
	LAZY_INITINFO(pt_regs_regs, "pt_regs", "regs");
	LAZY_INITINFO(qstr_name, "qstr", "name");
	LAZY_INITINFO(radix_tree_node_height, "radix_tree_node", "height");
	LAZY_INITINFO(radix_tree_node_shift, "radix_tree_node", "shift");
	LAZY_INITINFO(radix_tree_node_slots, "radix_tree_node", "slots");
	LAZY_INITINFO(radix_tree_root_height, "radix_tree_root", "height");
	LAZY_INITINFO(radix_tree_root_rnode, "radix_tree_root", "rnode");
	LAZY_INITINFO(rb_node_rb_left, "rb_node", "rb_left");
	LAZY_INITINFO(rb_node_rb_right, "rb_node", "rb_right");
	LAZY_INITINFO(rb_root_cached_rb_leftmost, "rb_root_cached", "rb_leftmost");
	LAZY_INITINFO(rb_root_rb_node, "rb_root", "rb_node");
	LAZY_INITINFO(request_cmd_flags, "request", "cmd_flags");
	LAZY_INITINFO(request_list_count, "request_list", "count");
	LAZY_INITINFO(request_q, "request", "q");
	LAZY_INITINFO(request_queue_hctx_table, "request_queue", "hctx_table");
	LAZY_INITINFO(request_queue_in_flight, "request_queue", "in_flight");
	LAZY_INITINFO(request_queue_mq_ops, "request_queue", "mq_ops");
	LAZY_INITINFO(request_queue_nr_hw_queues, "request_queue", "nr_hw_queues");
	LAZY_INITINFO(request_queue_queue_hw_ctx, "request_queue", "queue_hw_ctx");
	LAZY_INITINFO(request_state, "request", "state");
	LAZY_INITINFO(resource_child, "resource", "child");
	LAZY_INITINFO(resource_end, "resource", "end");
	LAZY_INITINFO(resource_entry_t_from, "resource_entry_t", "from");
	LAZY_INITINFO(resource_entry_t_name, "resource_entry_t", "name");
	LAZY_INITINFO(resource_entry_t_next, "resource_entry_t", "next");
	LAZY_INITINFO(resource_entry_t_num, "resource_entry_t", "num");
	LAZY_INITINFO(resource_name, "resource", "name");
	LAZY_INITINFO(resource_sibling, "resource", "sibling");
	LAZY_INITINFO(resource_start, "resource", "start");
	LAZY_INITINFO(rq_cfs, "rq", "cfs");
	LAZY_INITINFO(rq_nr_running, "rq", "nr_running");
	LAZY_INITINFO(rq_rt, "rq", "rt");
	LAZY_INITINFO(rt_prio_array_queue, "rt_prio_array", "queue");
	LAZY_INITINFO(rt_rq_active, "rt_rq", "active");
	LAZY_INITINFO(rt_rq_highest_prio, "rt_rq", "highest_prio");
	LAZY_INITINFO(rt_rq_rt_nr_running, "rt_rq", "rt_nr_running");
	LAZY_INITINFO(rt_rq_rt_throttled, "rt_rq", "rt_throttled");
	LAZY_INITINFO(rt_rq_tg, "rt_rq", "tg");
	LAZY_INITINFO(sbitmap_alloc_hint, "sbitmap", "alloc_hint");
	LAZY_INITINFO(sbitmap_depth, "sbitmap", "depth");
	LAZY_INITINFO(sbitmap_map, "sbitmap", "map");
	LAZY_INITINFO(sbitmap_map_nr, "sbitmap", "map_nr");
	LAZY_INITINFO(sbitmap_queue_alloc_hint, "sbitmap_queue", "alloc_hint");
	LAZY_INITINFO(sbitmap_queue_min_shallow_depth, "sbitmap_queue", "min_shallow_depth");
	LAZY_INITINFO(sbitmap_queue_round_robin, "sbitmap_queue", "round_robin");
	LAZY_INITINFO(sbitmap_queue_sb, "sbitmap_queue", "sb");
	LAZY_INITINFO(sbitmap_queue_wake_batch, "sbitmap_queue", "wake_batch");
	LAZY_INITINFO(sbitmap_queue_wake_index, "sbitmap_queue", "wake_index");
	LAZY_INITINFO(sbitmap_queue_ws, "sbitmap_queue", "ws");
	LAZY_INITINFO(sbitmap_queue_ws_active, "sbitmap_queue", "ws_active");
	LAZY_INITINFO(sbitmap_round_robin, "sbitmap", "round_robin");
	LAZY_INITINFO(sbitmap_shift, "sbitmap", "shift");
	LAZY_INITINFO(sbitmap_word_cleared, "sbitmap_word", "cleared");
	LAZY_INITINFO(sbitmap_word_depth, "sbitmap_word", "depth");
	LAZY_INITINFO(sbitmap_word_word, "sbitmap_word", "word");
	LAZY_INITINFO(sbq_wait_state_wait, "sbq_wait_state", "wait");
	LAZY_INITINFO(sbq_wait_state_wait_cnt, "sbq_wait_state", "wait_cnt");
	LAZY_INITINFO(sched_entity_cfs_rq, "sched_entity", "cfs_rq");
	LAZY_INITINFO(sched_entity_my_q, "sched_entity", "my_q");
	LAZY_INITINFO(sched_entity_on_rq, "sched_entity", "on_rq");
	LAZY_INITINFO(sched_entity_run_node, "sched_entity", "run_node");
	LAZY_INITINFO(sched_info_last_arrival, "sched_info", "last_arrival");
	LAZY_INITINFO(sched_rt_entity_my_q, "sched_rt_entity", "my_q");
	LAZY_INITINFO(sched_rt_entity_run_list, "sched_rt_entity", "run_list");
	LAZY_INITINFO(sem_array_sem_id, "sem_array", "sem_id");
	LAZY_INITINFO(sem_array_sem_nsems, "sem_array", "sem_nsems");
	LAZY_INITINFO(sem_array_sem_perm, "sem_array", "sem_perm");
	LAZY_INITINFO(shm_file_data_file, "shm_file_data", "file");
	LAZY_INITINFO(shmem_inode_info_vfs_inode, "shmem_inode_info", "vfs_inode");
	LAZY_INITINFO(shmid_kernel_id, "shmid_kernel", "id");
	LAZY_INITINFO(shmid_kernel_shm_file, "shmid_kernel", "shm_file");
	LAZY_INITINFO(shmid_kernel_shm_nattch, "shmid_kernel", "shm_nattch");
	LAZY_INITINFO(shmid_kernel_shm_perm, "shmid_kernel", "shm_perm");
	LAZY_INITINFO(shmid_kernel_shm_segsz, "shmid_kernel", "shm_segsz");
	LAZY_INITINFO(sigaction_sa_flags, "sigaction", "sa_flags");
	LAZY_INITINFO(sigaction_sa_handler, "sigaction", "sa_handler");
	LAZY_INITINFO(sigaction_sa_mask, "sigaction", "sa_mask");
	LAZY_INITINFO(sighand_struct_action, "sighand_struct", "action");
	LAZY_INITINFO(siginfo_si_signo, "siginfo", "si_signo");
	LAZY_INITINFO(signal_queue_info, "signal_queue", "info");
	LAZY_INITINFO(signal_queue_next, "signal_queue", "next");
	LAZY_INITINFO(signal_struct_action, "signal_struct", "action");
	LAZY_INITINFO(signal_struct_count, "signal_struct", "count");
	LAZY_INITINFO(signal_struct_nr_threads, "signal_struct", "nr_threads");
	LAZY_INITINFO(signal_struct_rlim, "signal_struct", "rlim");
	LAZY_INITINFO(signal_struct_shared_pending, "signal_struct", "shared_pending");
	LAZY_INITINFO(sigpending_head, "sigpending", "head");
	LAZY_INITINFO(sigpending_list, "sigpending", "list");
	LAZY_INITINFO(sigpending_signal, "sigpending", "signal");
	LAZY_INITINFO(sigqueue_info, "sigqueue", "info");
	LAZY_INITINFO(sigqueue_list, "sigqueue", "list");
	LAZY_INITINFO(sigqueue_next, "sigqueue", "next");
	LAZY_INITINFO(size_class_size, "size_class", "size");
	LAZY_INITINFO(sk_buff_data, "sk_buff", "data");
	LAZY_INITINFO(sk_buff_head_next, "sk_buff_head", "next");
	LAZY_INITINFO(sk_buff_head_qlen, "sk_buff_head", "qlen");
	LAZY_INITINFO(sk_buff_len, "sk_buff", "len");
	LAZY_INITINFO(sk_buff_next, "sk_buff", "next");
	LAZY_INITINFO(slab_s_free, "slab_s", "free");
	LAZY_INITINFO(slab_s_inuse, "slab_s", "inuse");
	LAZY_INITINFO(slab_s_list, "slab_s", "list");
	LAZY_INITINFO(slab_s_s_mem, "slab_s", "s_mem");
	LAZY_INITINFO(slab_slab_list, "slab", "slab_list");
	LAZY_INITINFO(sock_common_skc_family, "sock_common", "skc_family");
	LAZY_INITINFO(sock_common_skc_v6_daddr, "sock_common", "skc_v6_daddr");
	LAZY_INITINFO(sock_common_skc_v6_rcv_saddr, "sock_common", "skc_v6_rcv_saddr");
	LAZY_INITINFO(sock_daddr, "sock", "daddr");
	LAZY_INITINFO(sock_dport, "sock", "dport");
	LAZY_INITINFO(sock_family, "sock", "family");
	LAZY_INITINFO(sock_num, "sock", "num");
	LAZY_INITINFO(sock_rcv_saddr, "sock", "rcv_saddr");
	LAZY_INITINFO(sock_sk_common, "sock", "__sk_common");
	LAZY_INITINFO(sock_sk_type, "sock", "sk_type");
	LAZY_INITINFO(sock_sport, "sock", "sport");
	LAZY_INITINFO(sock_type, "sock", "type");
	LAZY_INITINFO(socket_alloc_vfs_inode, "socket_alloc", "vfs_inode");
	LAZY_INITINFO(socket_sk, "socket", "sk");
	LAZY_INITINFO(subsys_private_klist_devices, "subsys_private", "klist_devices");
	LAZY_INITINFO(subsys_private_subsys, "subsys_private", "subsys");
	LAZY_INITINFO(subsystem_kset, "subsystem", "kset");
	LAZY_INITINFO(super_block_s_dirty, "super_block", "s_dirty");
	LAZY_INITINFO(super_block_s_files, "super_block", "s_files");
	LAZY_INITINFO(super_block_s_fs_info, "super_block", "s_fs_info");
	LAZY_INITINFO(super_block_s_inodes, "super_block", "s_inodes");
	LAZY_INITINFO(super_block_s_type, "super_block", "s_type");
	LAZY_INITINFO(svc_client_cl_ident, "svc_client", "cl_ident");
	LAZY_INITINFO(swap_info_struct_bdev, "swap_info_struct", "bdev");
	LAZY_INITINFO(swap_info_struct_flags, "swap_info_struct", "flags");
	LAZY_INITINFO(swap_info_struct_inuse_pages, "swap_info_struct", "inuse_pages");
	LAZY_INITINFO(swap_info_struct_max, "swap_info_struct", "max");
	LAZY_INITINFO(swap_info_struct_old_block_size, "swap_info_struct", "old_block_size");
	LAZY_INITINFO(swap_info_struct_pages, "swap_info_struct", "pages");
	LAZY_INITINFO(swap_info_struct_prio, "swap_info_struct", "prio");
	LAZY_INITINFO(swap_info_struct_swap_device, "swap_info_struct", "swap_device");
	LAZY_INITINFO(swap_info_struct_swap_file, "swap_info_struct", "swap_file");
	LAZY_INITINFO(swap_info_struct_swap_map, "swap_info_struct", "swap_map");
	LAZY_INITINFO(swap_info_struct_swap_vfsmnt, "swap_info_struct", "swap_vfsmnt");
	LAZY_INITINFO(switch_stack_ar_bspstore, "switch_stack", "ar_bspstore");
	LAZY_INITINFO(switch_stack_ar_pfs, "switch_stack", "ar_pfs");
	LAZY_INITINFO(switch_stack_ar_rnat, "switch_stack", "ar_rnat");
	LAZY_INITINFO(switch_stack_b0, "switch_stack", "b0");
	LAZY_INITINFO(switch_stack_pr, "switch_stack", "pr");
	LAZY_INITINFO(switch_stack_r26, "switch_stack", "r26");
	LAZY_INITINFO(task_group_cfs_bandwidth, "task_group", "cfs_bandwidth");
	LAZY_INITINFO(task_group_cfs_rq, "task_group", "cfs_rq");
	LAZY_INITINFO(task_group_children, "task_group", "children");
	LAZY_INITINFO(task_group_css, "task_group", "css");
	LAZY_INITINFO(task_group_parent, "task_group", "parent");
	LAZY_INITINFO(task_group_rt_bandwidth, "task_group", "rt_bandwidth");
	LAZY_INITINFO(task_group_rt_rq, "task_group", "rt_rq");
	LAZY_INITINFO(task_group_siblings, "task_group", "siblings");
	LAZY_INITINFO(task_rss_stat_count, "task_rss_stat", "count");
	LAZY_INITINFO(task_struct_active_mm, "task_struct", "active_mm");
	LAZY_INITINFO(task_struct_blocked, "task_struct", "blocked");
	LAZY_INITINFO(task_struct_comm, "task_struct", "comm");
	LAZY_INITINFO(task_struct_cpu, "task_struct", "cpu");
	LAZY_INITINFO(task_struct_cpus_runnable, "task_struct", "cpus_runnable");
	LAZY_INITINFO(task_struct_exit_state, "task_struct", "exit_state");
	LAZY_INITINFO(task_struct_files, "task_struct", "files");
	LAZY_INITINFO(task_struct_flags, "task_struct", "flags");
	LAZY_INITINFO(task_struct_fs, "task_struct", "fs");
	LAZY_INITINFO(task_struct_has_cpu, "task_struct", "has_cpu");
	LAZY_INITINFO(task_struct_last_run, "task_struct", "last_run");
	LAZY_INITINFO(task_struct_mm, "task_struct", "mm");
	LAZY_INITINFO(task_struct_next_run, "task_struct", "next_run");
	LAZY_INITINFO(task_struct_next_task, "task_struct", "next_task");
	LAZY_INITINFO(task_struct_nsproxy, "task_struct", "nsproxy");
	LAZY_INITINFO(task_struct_on_rq, "task_struct", "on_rq");
	LAZY_INITINFO(task_struct_p_pptr, "task_struct", "p_pptr");
	LAZY_INITINFO(task_struct_pending, "task_struct", "pending");
	LAZY_INITINFO(task_struct_pgrp, "task_struct", "pgrp");
	LAZY_INITINFO(task_struct_pid, "task_struct", "pid");
	LAZY_INITINFO(task_struct_pid_links, "task_struct", "pid_links");
	LAZY_INITINFO(task_struct_pidhash_next, "task_struct", "pidhash_next");
	LAZY_INITINFO(task_struct_pids, "task_struct", "pids");
	LAZY_INITINFO(task_struct_policy, "task_struct", "policy");
	LAZY_INITINFO(task_struct_prio, "task_struct", "prio");
	LAZY_INITINFO(task_struct_processor, "task_struct", "processor");
	LAZY_INITINFO(task_struct_rlim, "task_struct", "rlim");
	LAZY_INITINFO(task_struct_rss_stat, "task_struct", "rss_stat");
	LAZY_INITINFO(task_struct_rt, "task_struct", "rt");
	LAZY_INITINFO(task_struct_run_list, "task_struct", "run_list");
	LAZY_INITINFO(task_struct_sched_info, "task_struct", "sched_info");
	LAZY_INITINFO(task_struct_se, "task_struct", "se");
	LAZY_INITINFO(task_struct_sig, "task_struct", "sig");
	LAZY_INITINFO(task_struct_sighand, "task_struct", "sighand");
	LAZY_INITINFO(task_struct_signal, "task_struct", "signal");
	LAZY_INITINFO(task_struct_sigpending, "task_struct", "sigpending");
	LAZY_INITINFO(task_struct_sigqueue, "task_struct", "sigqueue");
	LAZY_INITINFO(task_struct_stack, "task_struct", "stack");
	LAZY_INITINFO(task_struct_start_time, "task_struct", "start_time");
	LAZY_INITINFO(task_struct_stime, "task_struct", "stime");
	LAZY_INITINFO(task_struct_tgid, "task_struct", "tgid");
	LAZY_INITINFO(task_struct_thread, "task_struct", "thread");
	LAZY_INITINFO(task_struct_times, "task_struct", "times");
	LAZY_INITINFO(task_struct_timestamp, "task_struct", "timestamp");
	LAZY_INITINFO(task_struct_tss, "task_struct", "tss");
	LAZY_INITINFO(task_struct_utime, "task_struct", "utime");
	LAZY_INITINFO(thread_info_cpu_context, "thread_info", "cpu_context");
	LAZY_INITINFO(thread_info_flags, "thread_info", "flags");
	LAZY_INITINFO(thread_struct_cr3, "thread_struct", "cr3");
	LAZY_INITINFO(thread_struct_fph, "thread_struct", "fph");
	LAZY_INITINFO(thread_struct_ksp, "thread_struct", "ksp");
	LAZY_INITINFO(thread_struct_pg_tables, "thread_struct", "pg_tables");
	LAZY_INITINFO(thread_struct_ptbr, "thread_struct", "ptbr");
	LAZY_INITINFO(timekeeper_xtime, "timekeeper", "xtime");
	LAZY_INITINFO(timekeeper_xtime_sec, "timekeeper", "xtime_sec");
	LAZY_INITINFO(timer_base_vectors, "timer_base", "vectors");
	LAZY_INITINFO(timer_list_entry, "timer_list", "entry");
	LAZY_INITINFO(timer_list_expires, "timer_list", "expires");
	LAZY_INITINFO(timer_list_function, "timer_list", "function");
	LAZY_INITINFO(timer_list_list, "timer_list", "list");
	LAZY_INITINFO(timer_list_next, "timer_list", "next");
	LAZY_INITINFO(timer_vec_root_vec, "timer_vec_root", "vec");
	LAZY_INITINFO(timer_vec_vec, "timer_vec", "vec");
	LAZY_INITINFO(timerqueue_head_next, "timerqueue_head", "next");
	LAZY_INITINFO(timerqueue_head_rb_root, "timerqueue_head", "rb_root");
	LAZY_INITINFO(timerqueue_node_expires, "timerqueue_node", "expires");
	LAZY_INITINFO(timerqueue_node_node, "timerqueue_node", "node");
	LAZY_INITINFO(tms_tms_stime, "tms", "tms_stime");
	LAZY_INITINFO(tms_tms_utime, "tms", "tms_utime");
	LAZY_INITINFO(tnt_bit, "tnt", "bit");
	LAZY_INITINFO(tnt_mod, "taint_flag", "module");
	LAZY_INITINFO(trace_print_flags_mask, "trace_print_flags", "mask");
	LAZY_INITINFO(trace_print_flags_name, "trace_print_flags", "name");
	LAZY_INITINFO(unwind_idx_addr, "unwind_idx", "addr");
	LAZY_INITINFO(unwind_idx_insn, "unwind_idx", "insn");
	LAZY_INITINFO(unwind_table_address, "unwind_table", "address");
	LAZY_INITINFO(unwind_table_begin_addr, "unwind_table", "begin_addr");
	LAZY_INITINFO(unwind_table_core, "unwind_table", "core");
	LAZY_INITINFO(unwind_table_end_addr, "unwind_table", "end_addr");
	LAZY_INITINFO(unwind_table_init, "unwind_table", "init");
	LAZY_INITINFO(unwind_table_link, "unwind_table", "link");
	LAZY_INITINFO(unwind_table_list, "unwind_table", "list");
	LAZY_INITINFO(unwind_table_name, "unwind_table", "name");
	LAZY_INITINFO(unwind_table_size, "unwind_table", "size");
	LAZY_INITINFO(unwind_table_start, "unwind_table", "start");
	LAZY_INITINFO(unwind_table_stop, "unwind_table", "stop");
	LAZY_INITINFO(upid_nr, "upid", "nr");
	LAZY_INITINFO(upid_ns, "upid", "ns");
	LAZY_INITINFO(upid_pid_chain, "upid", "pid_chain");
	LAZY_INITINFO(user_struct_uid, "user_struct", "uid");
	LAZY_INITINFO(uts_namespace_name, "uts_namespace", "name");
	LAZY_INITINFO(vcpu_guest_context_user_regs, "vcpu_guest_context", "user_regs");
	LAZY_INITINFO(vcpu_struct_rq, "vcpu_struct", "rq");
	LAZY_INITINFO(vfsmount_mnt_devname, "vfsmount", "mnt_devname");
	LAZY_INITINFO(vfsmount_mnt_dirname, "vfsmount", "mnt_dirname");
	LAZY_INITINFO(vfsmount_mnt_list, "vfsmount", "mnt_list");
	LAZY_INITINFO(vfsmount_mnt_mountpoint, "vfsmount", "mnt_mountpoint");
	LAZY_INITINFO(vfsmount_mnt_next, "vfsmount", "mnt_next");
	LAZY_INITINFO(vfsmount_mnt_parent, "vfsmount", "mnt_parent");
	LAZY_INITINFO(vfsmount_mnt_sb, "vfsmount", "mnt_sb");
	LAZY_INITINFO(vm_area_struct_vm_end, "vm_area_struct", "vm_end");
	LAZY_INITINFO(vm_area_struct_vm_file, "vm_area_struct", "vm_file");
	LAZY_INITINFO(vm_area_struct_vm_flags, "vm_area_struct", "vm_flags");
	LAZY_INITINFO(vm_area_struct_vm_mm, "vm_area_struct", "vm_mm");
	LAZY_INITINFO(vm_area_struct_vm_next, "vm_area_struct", "vm_next");
	LAZY_INITINFO(vm_area_struct_vm_offset, "vm_area_struct", "vm_offset");
	LAZY_INITINFO(vm_area_struct_vm_pgoff, "vm_area_struct", "vm_pgoff");
	LAZY_INITINFO(vm_area_struct_vm_start, "vm_area_struct", "vm_start");
	LAZY_INITINFO(vm_struct_addr, "vm_struct", "addr");
	LAZY_INITINFO(vm_struct_next, "vm_struct", "next");
	LAZY_INITINFO(vm_struct_size, "vm_struct", "size");
	LAZY_INITINFO(vmap_area_flags, "vmap_area", "flags");
	LAZY_INITINFO(vmap_area_list, "vmap_area", "list");
	LAZY_INITINFO(vmap_area_va_end, "vmap_area", "va_end");
	LAZY_INITINFO(vmap_area_va_start, "vmap_area", "va_start");
	LAZY_INITINFO(wait_queue_entry_entry, "wait_queue_entry", "entry");
	LAZY_INITINFO(wait_queue_entry_private, "wait_queue_entry", "private");
	LAZY_INITINFO(wait_queue_head_head, "wait_queue_head", "head");
	LAZY_INITINFO(wait_queue_next, "wait_queue", "next");
	LAZY_INITINFO(wait_queue_task, "wait_queue", "task");
	LAZY_INITINFO(x8664_pda_cpunumber, "x8664_pda", "cpunumber");
	LAZY_INITINFO(x8664_pda_data_offset, "x8664_pda", "data_offset");
	LAZY_INITINFO(x8664_pda_irqrsp, "x8664_pda", "irqrsp");
	LAZY_INITINFO(x8664_pda_irqstackptr, "x8664_pda", "irqstackptr");
	LAZY_INITINFO(x8664_pda_kernelstack, "x8664_pda", "kernelstack");
	LAZY_INITINFO(x8664_pda_level4_pgt, "x8664_pda", "level4_pgt");
	LAZY_INITINFO(x8664_pda_me, "x8664_pda", "me");
	LAZY_INITINFO(x8664_pda_pcurrent, "x8664_pda", "pcurrent");
	LAZY_INITINFO(xa_node_shift, "xa_node", "shift");
	LAZY_INITINFO(xa_node_slots, "xa_node", "slots");
	LAZY_INITINFO(xarray_xa_head, "xarray", "xa_head");
	LAZY_INITINFO(zone_all_unreclaimable, "zone", "all_unreclaimable");
	LAZY_INITINFO(zone_flags, "zone", "flags");
	LAZY_INITINFO(zone_free_area, "zone", "free_area");
	LAZY_INITINFO(zone_name, "zone", "name");
	LAZY_INITINFO(zone_nr_active, "zone", "nr_active");
	LAZY_INITINFO(zone_nr_inactive, "zone", "nr_inactive");
	LAZY_INITINFO(zone_pages_high, "zone", "pages_high");
	LAZY_INITINFO(zone_pages_low, "zone", "pages_low");
	LAZY_INITINFO(zone_pages_min, "zone", "pages_min");
	LAZY_INITINFO(zone_pages_scanned, "zone", "pages_scanned");
	LAZY_INITINFO(zone_present_pages, "zone", "present_pages");
	LAZY_INITINFO(zone_spanned_pages, "zone", "spanned_pages");
	LAZY_INITINFO(zone_struct_active_pages, "zone_struct", "active_pages");
	LAZY_INITINFO(zone_struct_free_area, "zone_struct", "free_area");
	LAZY_INITINFO(zone_struct_free_pages, "zone_struct", "free_pages");
	LAZY_INITINFO(zone_struct_inactive_clean_list, "zone_struct", "inactive_clean_list");
	LAZY_INITINFO(zone_struct_inactive_clean_pages, "zone_struct", "inactive_clean_pages");
	LAZY_INITINFO(zone_struct_inactive_dirty_pages, "zone_struct", "inactive_dirty_pages");
	LAZY_INITINFO(zone_struct_memsize, "zone_struct", "memsize");
	LAZY_INITINFO(zone_struct_name, "zone_struct", "name");
	LAZY_INITINFO(zone_struct_pages_high, "zone_struct", "pages_high");
	LAZY_INITINFO(zone_struct_pages_low, "zone_struct", "pages_low");
	LAZY_INITINFO(zone_struct_pages_min, "zone_struct", "pages_min");
	LAZY_INITINFO(zone_struct_size, "zone_struct", "size");
	LAZY_INITINFO(zone_struct_zone_mem_map, "zone_struct", "zone_mem_map");
	LAZY_INITINFO(zone_struct_zone_pgdat, "zone_struct", "zone_pgdat");
	LAZY_INITINFO(zone_struct_zone_start_mapnr, "zone_struct", "zone_start_mapnr");
	LAZY_INITINFO(zone_struct_zone_start_paddr, "zone_struct", "zone_start_paddr");
	LAZY_INITINFO(zone_struct_zone_start_pfn, "zone_struct", "zone_start_pfn");
	LAZY_INITINFO(zone_vm_stat, "zone", "vm_stat");
	LAZY_INITINFO(zone_zone_mem_map, "zone", "zone_mem_map");
	LAZY_INITINFO(zone_zone_pgdat, "zone", "zone_pgdat");
	LAZY_INITINFO(zone_zone_start_pfn, "zone", "zone_start_pfn");
	LAZY_INITINFO(zram_compressor, "zram", "compressor");
	LAZY_INITINFO(zram_mempoll, "zram", "mem_pool");
	LAZY_INITINFO(zspoll_size_class, "zs_pool", "size_class");
}
...
vm_init(void)
{
	...
	if (VALID_MEMBER_LAZY(vmap_area_va_start) &&
	    VALID_MEMBER_LAZY(vmap_area_va_end) &&
	    VALID_MEMBER_LAZY(vmap_area_list) &&
	...
	if (VALID_MEMBER_LAZY(page_list)) {
		...
		ASSIGN_OFFSET(page_list_prev) = LAZY_OFFSET(page_list) +
	...
	if (MEMBER_EXISTS("kmem_cache", "freelist_size")) {
		...
		if (VALID_STRUCT(kmem_cache_s)) {
			...
			if (MEMBER_EXISTS("kmem_cache", "lists"))
				...
				} else if (VALID_MEMBER_LAZY(kmem_cache_cpu_cache)) {
					/*
		...
		if (VALID_MEMBER_LAZY(kmem_cache_node)) {
	...
	if (kernel_symbol_exists("slab_root_caches")) {
		if (VALID_MEMBER_LAZY(kmem_cache_memcg_params)
		    ...
		    && VALID_MEMBER_LAZY(memcg_cache_params_children_node))
	...
	if (symbol_exists("_totalram_pages")) {
		readmem(symbol_value("_totalram_pages") +
			LAZY_OFFSET(atomic_t_counter), KVADDR,
...
get_vm_flags(char *vma_buf)
{
	...
	if (SIZE(vm_area_struct_vm_flags) == sizeof(short))
		vm_flags = USHORT(vma_buf + LAZY_OFFSET(vm_area_struct_vm_flags));
	else if (SIZE(vm_area_struct_vm_flags) == sizeof(long))
		vm_flags = ULONG(vma_buf+ LAZY_OFFSET(vm_area_struct_vm_flags));
	else if (SIZE(vm_area_struct_vm_flags) == sizeof(long long))
		vm_flags = ULONGLONG(vma_buf+ LAZY_OFFSET(vm_area_struct_vm_flags));
	else
...
is_valid_mm(ulong mm)
{
	...
	readmem(mm + LAZY_OFFSET(mm_struct_mm_count), KVADDR, &mm_count, sizeof(int),
...
static ulong handle_each_vm_area(struct handle_each_vm_area_args *args)
{
	...
	*(args->vma_buf) = fill_vma_cache(args->vma);
	...
	vm_mm = ULONG(*(args->vma_buf) + LAZY_OFFSET(vm_area_struct_vm_mm));
	vm_end = ULONG(*(args->vma_buf) + LAZY_OFFSET(vm_area_struct_vm_end));
	vm_start = ULONG(*(args->vma_buf) + LAZY_OFFSET(vm_area_struct_vm_start));
	vm_flags = get_vm_flags(*(args->vma_buf));
	vm_file = ULONG(*(args->vma_buf) + LAZY_OFFSET(vm_area_struct_vm_file));
...
vm_area_dump(ulong task, ulong flag, ulong vaddr, struct reference *ref)
{
	...
	if (INVALID_MEMBER_LAZY(mm_struct_mmap) && VALID_MEMBER_LAZY(mm_struct_mm_mt)) {
		mm_mt = tm->mm_struct_addr + LAZY_OFFSET(mm_struct_mm_mt);
		...
		readmem(tm->mm_struct_addr + LAZY_OFFSET(mm_struct_mmap), KVADDR,
			&vma, sizeof(void *), "mm_struct mmap", FAULT_ON_ERROR);
		while (vma) {
			args.vma = vma;
			if (handle_each_vm_area(&args))
				return vma;
			vma = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_next));
		}
	}
...
rss_page_types_init(void)
{
	...
	if (VALID_MEMBER_LAZY(mm_struct_rss_stat)) 
	{
...
get_task_mem_usage(ulong task, struct task_mem_usage *tm)
{
	...
	if (VALID_MEMBER(mm_struct_rss))
		 ...
		 */ 
		if (VALID_MEMBER_LAZY(mm_struct_rss_stat) && VALID_MEMBER_LAZY(mm_rss_stat_count)) {
		...
		} else if (VALID_MEMBER_LAZY(mm_struct_rss_stat)) {
			/* 6.2: struct percpu_counter rss_stat[NR_MM_COUNTERS] */
			ulong fbc;

			fbc = tc->mm_struct + LAZY_OFFSET(mm_struct_rss_stat) +
		...
		if (VALID_MEMBER_LAZY(task_struct_rss_stat)) {
			int sync_rss;
				...
				if (ACTIVE() || last->rss_cache == UNINITIALIZED) {
					while (first <= last)
					{
						...
						if (!readmem(first->task +
							...
							LAZY_OFFSET(task_rss_stat_count), KVADDR,
							&sync_rss,
							sizeof(int),
		...
		if (VALID_MEMBER_LAZY(mm_struct_anon_rss))
			rss +=  LONG(tt->mm_struct + LAZY_OFFSET(mm_struct_anon_rss));
		if (VALID_MEMBER_LAZY(mm_struct_file_rss))
			rss +=  LONG(tt->mm_struct + LAZY_OFFSET(mm_struct_file_rss));

		tm->rss = (unsigned long)rss;
	}
        tm->total_vm = ULONG(tt->mm_struct + LAZY_OFFSET(mm_struct_total_vm));
        tm->pgd_addr = ULONG(tt->mm_struct + LAZY_OFFSET(mm_struct_pgd));
...
PG_reserved_flag_init(void)
{
	...
	flags = ULONG(buf + LAZY_OFFSET(page_flags));
...
PG_slab_flag_init(void)
{
	...
	} else if (VALID_MEMBER_LAZY(page_pte)) {
...
dump_mem_map_SPARSEMEM(struct meminfo *mi)
{
	...
	v22 = VALID_MEMBER_LAZY(page_inode);  /* page.inode vs. page.mapping */
	 ...
	 */
		...
		for (i = 0; i < section_size; 
			...
			flags = ULONG(pcache + LAZY_OFFSET(page_flags));
			...
			case GET_ALL:
			case GET_BUFFERS_PAGES:
				if (VALID_MEMBER_LAZY(page_buffers)) {
					tmp = ULONG(pcache + 
			...
			if (v22) {
				inode = ULONG(pcache + LAZY_OFFSET(page_inode));
...
dump_hstates()
{
	...
	if (INVALID_SIZE(hstate) ||
	    INVALID_MEMBER_LAZY(hstate_order) ||
	    INVALID_MEMBER_LAZY(hstate_name) ||
	    INVALID_MEMBER_LAZY(hstate_nr_huge_pages) ||
	    INVALID_MEMBER_LAZY(hstate_free_huge_pages)) {
	...
	for (i = 0; i < len; i++) {
		...
		order = INT(hstate + LAZY_OFFSET(hstate_order));
		if (!order)
			continue;
		...
		free = LONG(hstate + LAZY_OFFSET(hstate_free_huge_pages));
		sprintf(buf1, "%ld", free);
		fprintf(fp, "%s  ", mkstring(buf2, 6, RJUST, buf1));

		nr = LONG(hstate + LAZY_OFFSET(hstate_nr_huge_pages));
		sprintf(buf1, "%ld", nr);
		fprintf(fp, "%s  ", mkstring(buf2, 6, RJUST, buf1));

		fprintf(fp, "%s\n", hstate + LAZY_OFFSET(hstate_name));
	}
...
page_flags_init_from_pageflag_names(void)
{
	...
	if (INVALID_SIZE(trace_print_flags) ||
	    INVALID_MEMBER_LAZY(trace_print_flags_mask) || 
	    INVALID_MEMBER_LAZY(trace_print_flags_name) ||
...
dump_page_hash_table(struct meminfo *hi)
{
	...
	for (i = total_cached = 0; i < len; i++, 
		...
		if (VALID_STRUCT(page_cache_bucket))
			pcache += LAZY_OFFSET(page_cache_bucket_chain);
		...
		ld->member_offset = LAZY_OFFSET(page_next_hash);
                cnt = do_list(ld);
                total_cached += cnt;
...
dump_free_pages_zones_v1(struct meminfo *fi)
{
	...
	if (VALID_MEMBER_LAZY(zone_struct_size))
		zone_size_offset =  LAZY_OFFSET(zone_struct_size);
	else if (VALID_MEMBER_LAZY(zone_struct_memsize))
		zone_size_offset =  LAZY_OFFSET(zone_struct_memsize);
	else
		error(FATAL, 
	...
	for (n = sum = found = 0; n < vt->numnodes; n++) {
                nt = &vt->node_table[n];
		node_zones = nt->pgdat + LAZY_OFFSET(pglist_data_node_zones);
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			fprintf(fp, "%3d   ", i);
	        	...
	        	readmem(node_zones+LAZY_OFFSET(zone_struct_name), KVADDR, 
				&value, sizeof(void *), 
	        	...
	        	readmem(node_zones+LAZY_OFFSET(zone_struct_free_pages), 
				KVADDR, &value, sizeof(ulong), 
				"node_zones free_pages", FAULT_ON_ERROR);
	
	                fprintf(fp, "%6ld  ", value);
	
	                readmem(node_zones+LAZY_OFFSET(zone_struct_zone_start_paddr),
	                        KVADDR, &zone_start_paddr, sizeof(ulong),
	                        "node_zones zone_start_paddr", FAULT_ON_ERROR);
	                readmem(node_zones+LAZY_OFFSET(zone_struct_zone_start_mapnr),
	                        KVADDR, &zone_start_mapnr, sizeof(ulong),
	                        "node_zones zone_start_mapnr", FAULT_ON_ERROR);
	                readmem(node_zones+LAZY_OFFSET(zone_struct_zone_mem_map),
...
dump_free_pages_zones_v2(struct meminfo *fi)
{
	...
	if (VALID_MEMBER_LAZY(zone_spanned_pages))
		zone_size_offset =  LAZY_OFFSET(zone_spanned_pages);
	else
		...
		for (i = 0; i < vt->nr_zones; i++) {
			if (fi->flags == GET_FREE_PAGES) {
				...
				continue;
	                ...
	                if (fi->flags == GET_FREE_HIGHMEM_PAGES) {
				readmem(node_zones+LAZY_OFFSET(zone_name), KVADDR,
					&value, sizeof(void *),
					"node_zones name", FAULT_ON_ERROR);
				if (read_string(value, buf, BUFSIZE-1) &&
				    STREQ(buf, "HighMem"))
			...
			if (VALID_MEMBER_LAZY(zone_zone_mem_map)) {
                        	readmem(node_zones+LAZY_OFFSET(zone_zone_mem_map),
                                	KVADDR, &zone_mem_map, sizeof(ulong),
                                	"node_zones zone_mem_map", FAULT_ON_ERROR);
			}

			readmem(node_zones+ LAZY_OFFSET(zone_zone_start_pfn),
...
dump_zone_page_usage(void)
{
	...
	if (!VALID_MEMBER_LAZY(zone_struct_inactive_dirty_pages) ||
	    !VALID_MEMBER_LAZY(zone_struct_inactive_clean_pages) ||
	    !VALID_MEMBER_LAZY(zone_struct_active_pages) ||
	    !VALID_MEMBER_LAZY(zone_struct_pages_min) ||
	    !VALID_MEMBER_LAZY(zone_struct_pages_low) ||
	    !VALID_MEMBER_LAZY(zone_struct_pages_high))
		return FALSE;
	...
	fprintf(fp, "\n");
		...
		fprintf(fp, "%s\n", page_usage_hdr);
			...
			readmem(node_zones+LAZY_OFFSET(zone_struct_free_pages),
				...
				FAULT_ON_ERROR);
		        readmem(node_zones+LAZY_OFFSET(zone_struct_active_pages),
		                KVADDR, &active_pages, sizeof(ulong),
		                "node_zones active_pages", FAULT_ON_ERROR);
		        readmem(node_zones+LAZY_OFFSET(zone_struct_pages_min),
		                KVADDR, &pages_min, sizeof(ulong),
		                "node_zones pages_min", FAULT_ON_ERROR);
		        readmem(node_zones+LAZY_OFFSET(zone_struct_pages_low),
		                KVADDR, &pages_low, sizeof(ulong),
		                "node_zones pages_low", FAULT_ON_ERROR);
		        readmem(node_zones+LAZY_OFFSET(zone_struct_pages_high),
		    ...
		    struct free_page_callback_data *callback_data)
{
	...
	for (i = 0; i < num; i++, 
		...
		if (VALID_MEMBER(page_list_next))
			ld->list_head_offset = LAZY_OFFSET(page_list);
...
dump_kmeminfo(void)
{
	...
	if (kernel_symbol_exists("sysctl_overcommit_memory")) {
		...
		if (symbol_exists("vm_committed_as")) {
			if (INVALID_MEMBER_LAZY(percpu_counter_count))
				goto bailout;
			...
			if (INVALID_MEMBER_LAZY(atomic_t_counter))
				goto bailout;
...
nr_blockdev_pages(void)
{
	...
	for (i = nrpages = 0; i < bdevcnt; i++) {
			...
			FAULT_ON_ERROR);
		inode = ULONG(block_device_buf + LAZY_OFFSET(block_device_bd_inode));
                readmem(inode, KVADDR, inode_buf, SIZE(inode), "inode buffer", 
			FAULT_ON_ERROR);
		address_space = ULONG(inode_buf + LAZY_OFFSET(inode_i_mapping));
...
nr_blockdev_pages_v2(void)
{
	...
	readmem(bd_sb + LAZY_OFFSET(super_block_s_inodes), KVADDR, &ld->start,
	...
	while (next) {
		if (!(pc->curcmd_flags & HEADER_PRINTED) && (next == vmlist) && 
			...
			pc->curcmd_flags |= HEADER_PRINTED;
                ...
                readmem(next+LAZY_OFFSET(vm_struct_addr), KVADDR, 
			&addr, sizeof(void *),
                        "vmlist addr", FAULT_ON_ERROR);
                readmem(next+LAZY_OFFSET(vm_struct_size), KVADDR, 
			&size, sizeof(ulong),
...
next_entry:
                readmem(next+LAZY_OFFSET(vm_struct_next), 
...
#define VM_VM_AREA 0x4   /* mm/vmalloc.c */
	...
	ld->list_head_offset = LAZY_OFFSET(vmap_area_list);
	...
	for (i = 0; i < cnt; i++) {
		...
		if (VALID_MEMBER_LAZY(vmap_area_flags) &&
		    VALID_MEMBER(vmap_area_purge_list)) {
			flags = ULONG(vmap_area_buf + LAZY_OFFSET(vmap_area_flags));
			if (flags != VM_VM_AREA)
				continue;
		} else {
		...
		start = ULONG(vmap_area_buf + LAZY_OFFSET(vmap_area_va_start));
		end = ULONG(vmap_area_buf + LAZY_OFFSET(vmap_area_va_end));
...
dump_page_lists(struct meminfo *mi)
{
	...
	if (mi->flags & GET_INACTIVE_LIST) {
		...
		if (INVALID_MEMBER_LAZY(zone_struct_inactive_clean_list))
			error(FATAL, 
        	...
        	for (n = 0; pgdat; n++) {
                	...
                	for (i = 0; i < vt->nr_zones; i++) {
                        	readmem(node_zones+LAZY_OFFSET(zone_struct_name), 
				...
				node_zones += SIZE(zone_struct);
                	...
                	readmem(pgdat + OFFSET_OPTION_DIRECT(
								get_lazy_offset(pglist_data_node_next),
								get_lazy_offset(pglist_data_pgdat_next)), KVADDR,
...
is_kmem_cache_addr(ulong vaddr, char *kbuf)
{
	...
	if ((vt->flags & KMALLOC_COMMON) && !symbol_exists("cache_cache"))
        ...
        name_offset = vt->flags & (PERCPU_KMALLOC_V1|PERCPU_KMALLOC_V2) ?
                OFFSET(kmem_cache_s_name) : LAZY_OFFSET(kmem_cache_s_c_name);
        next_offset = vt->flags & (PERCPU_KMALLOC_V1|PERCPU_KMALLOC_V2) ?
                OFFSET(kmem_cache_s_next) : LAZY_OFFSET(kmem_cache_s_c_nextp);
 ...
 */
static void
kmem_cache_list_(struct meminfo *mi)
{
        ulong cache, cache_cache, name;
	long next_offset, name_offset;
	char *cache_buf;
...
vaddr_to_kmem_cache(ulong vaddr, char *buf, int verbose)
{
	...
	if ((vt->flags & KMALLOC_SLUB) ||
	    ...
	    (VALID_MEMBER(page_compound_head) || VALID_MEMBER(page_first_page)))) {
                ...
                readmem(page+OFFSET(page_lru)+LAZY_OFFSET(list_head_next),
                        KVADDR, &cache, sizeof(void *),
...
vaddr_to_slab(ulong vaddr)
{
	...
	slab = 0;
		...
		slab = compound_head(page);
        ...
        else if (VALID_MEMBER_LAZY(page_prev))
                readmem(page+LAZY_OFFSET(page_prev),
                        KVADDR, &slab, sizeof(void *),
                ...
                readmem(page+OFFSET(page_lru)+LAZY_OFFSET(list_head_prev),
                        KVADDR, &slab, sizeof(void *),
...
kmem_cache_init(void)
{
	...
	num_offset = vt->flags & (PERCPU_KMALLOC_V1|PERCPU_KMALLOC_V2) ? 
		OFFSET(kmem_cache_s_num) : LAZY_OFFSET(kmem_cache_s_c_num);
	next_offset = vt->flags & (PERCPU_KMALLOC_V1|PERCPU_KMALLOC_V2) ?
		OFFSET(kmem_cache_s_next) : LAZY_OFFSET(kmem_cache_s_c_nextp);
...
kmem_cache_downsize(void)
{
	...
	if (vt->flags & NODELISTS_IS_PTR) {
		...
		if (STRUCT_SIZE("kmem_cache") != SIZE(kmem_cache_s))
			...
			object_size = LAZY_OFFSET(kmem_cache_node) +
...
max_cpudata_limit(ulong cache, ulong *cpus)
{
	...
	if (vt->flags & PERCPU_KMALLOC_V2)
	 ...
	 if (INVALID_MEMBER_LAZY(kmem_cache_s_cpudata)) {
		*cpus = 0;
		return 0;
	}

	if (!readmem(cache+LAZY_OFFSET(kmem_cache_s_cpudata),
            KVADDR, &cpudata[0], 
	...
	for (i = max_limit = 0; (i < ARRAY_LENGTH(kmem_cache_s_cpudata)) && 
	     cpudata[i]; i++) {
		if (!readmem(cpudata[i]+LAZY_OFFSET(cpucache_s_limit),
...
kmem_cache_s_array:
	...
	for (i = max_limit = 0; (i < ARRAY_LENGTH(kmem_cache_s_array)) && 
	     cpudata[i]; i++) {
                if (!readmem(cpudata[i]+LAZY_OFFSET(array_cache_limit),
                    KVADDR, &limit, sizeof(int),
	...
	if (VALID_MEMBER(kmem_list3_shared) &&
	    ...
	    readmem(shared+LAZY_OFFSET(array_cache_limit), 
...
kmem_cache_s_array_nodes:
	...
	if (vt->flags & SLAB_CPU_CACHE) {
		if (!readmem(cache+LAZY_OFFSET(kmem_cache_cpu_cache), KVADDR, &percpu_ptr, 
	...
	if (VALID_MEMBER(kmem_list3_shared) && VALID_MEMBER(kmem_cache_s_lists) &&
		...
		for (i = 0; i < vt->kmem_cache_len_nodes; i++) {
			...
			if (readmem(start_address[i] + OFFSET(kmem_list3_shared), 
				...
				continue;
			if (readmem(shared + LAZY_OFFSET(array_cache_limit),
	       		    KVADDR, &limit, sizeof(int), "shared array_cache limit",
		            RETURN_ON_ERROR|QUIET)) {
				if (CRASHDEBUG(3))
					fprintf(fp, 
...
dump_kmem_cache(struct meminfo *si)
{
	...
	if (si->flags & CACHE_SET) {
		readmem(si->cache+LAZY_OFFSET(kmem_cache_s_c_nextp),
	...
	do {
		...
		if (vt->kmem_cache_namelen) {
			BCOPY(si->cache_buf + LAZY_OFFSET(kmem_cache_s_c_name),
		...
		magic = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_s_c_magic));
...
next_cache:
		si->cache = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_s_c_nextp));
...
dump_kmem_cache_percpu_v2(struct meminfo *si)
{
	...
	if (vt->flags & SLAB_OVERLOAD_PAGE) {
		...
		si->list_offset = VALID_MEMBER_LAZY(slab_slab_list) ?
					LAZY_OFFSET(slab_slab_list) : OFFSET(page_lru);
	}
	for (i = 0; i < vt->kmem_max_cpus; i++) 
		si->cpudata[i] = (ulong *)
			GETBUF(vt->kmem_max_limit * sizeof(ulong)); 
...
do_slab_chain(int cmd, struct meminfo *si)
{
	...
	kmem_slab_end = si->cache + LAZY_OFFSET(kmem_cache_s_c_offset);

	switch (cmd)
	{
	case SLAB_GET_COUNTS:
		si->slab = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_s_c_firstp));
...
do_slab_chain_percpu_v1(long cmd, struct meminfo *si)
{
	...
	if (VALID_MEMBER_LAZY(kmem_cache_s_slabs)) {
		slab_chains[0] = si->cache + LAZY_OFFSET(kmem_cache_s_slabs);
		slab_chains[1] = 0;
		slab_chains[2] = 0;
	} else {
		slab_chains[0] = si->cache + LAZY_OFFSET(kmem_cache_s_slabs_full);
		slab_chains[1] = si->cache + LAZY_OFFSET(kmem_cache_s_slabs_partial);
		slab_chains[2] = si->cache + LAZY_OFFSET(kmem_cache_s_slabs_free);
	}
	...
	case SLAB_GET_COUNTS:
		...
		for (s = 0; s < SLAB_CHAINS; s++) {
			...
			do {
				...
				last = si->slab - LAZY_OFFSET(slab_s_list);
	
		                readmem(si->slab, KVADDR, slab_s_buf, 
					SIZE(slab_s), "slab_s buffer", 
					FAULT_ON_ERROR);
	
				tmp = INT(slab_s_buf + LAZY_OFFSET(slab_s_inuse));
				si->inuse += tmp;
				...
				si->slab -= LAZY_OFFSET(slab_s_list);
			...
			if (CRASHDEBUG(1)) {
				...
				last = si->slab - LAZY_OFFSET(slab_s_list);
					...
					return;
		                ...
		                readmem(si->slab+LAZY_OFFSET(slab_s_list),
		                        KVADDR, &si->slab, sizeof(ulong),
...
verify_slab_v1(struct meminfo *si, ulong last, int s)
{
	...
	errcnt = 0;
		...
		(slab_s_buf + LAZY_OFFSET(slab_s_list));
	...
	inuse = UINT(slab_s_buf + LAZY_OFFSET(slab_s_inuse));
	if (inuse > si->c_num) {
	...
	case 0: /* full -- but can be one singular list */
                if (VALID_MEMBER_LAZY(kmem_cache_s_slabs_full) && 
		    (inuse != si->c_num)) {
                        error(INFO,
...
no_inuse_check_v1:
	s_mem = ULONG(slab_s_buf + LAZY_OFFSET(slab_s_s_mem));
...
{
	si->s_mem = ULONG(si->slab_buf + LAZY_OFFSET(kmem_slab_s_s_mem));
	...
	si->s_freep = VOID_PTR(si->slab_buf + LAZY_OFFSET(kmem_slab_s_s_freep));
	si->s_inuse = ULONG(si->slab_buf + LAZY_OFFSET(kmem_slab_s_s_inuse));
	si->s_index = ULONG_PTR(si->slab_buf + LAZY_OFFSET(kmem_slab_s_s_index));
...
dump_slab_percpu_v1(struct meminfo *si)
{
	int tmp;
        ...
        readmem(si->slab+LAZY_OFFSET(slab_s_s_mem),
	...
	tmp = SIZE(slab_s) + (SIZE(kmem_bufctl_t) * si->c_num);
        ...
        readmem(si->slab+LAZY_OFFSET(slab_s_inuse),
                KVADDR, &tmp, sizeof(int),
                "inuse", FAULT_ON_ERROR);
	si->s_inuse = tmp;

        readmem(si->slab+LAZY_OFFSET(slab_s_free),
...
dump_slab_objects(struct meminfo *si)
{
	...
	si->container = 0;
		 ...
		 */
        	readmem(si->slab+LAZY_OFFSET(kmem_slab_s_s_mem),
...
gather_cpudata_list_v1(struct meminfo *si)
{
	...
	int avail;
        ...
        readmem(si->cache+LAZY_OFFSET(kmem_cache_s_cpudata),
                KVADDR, &cpudata[0], 
		sizeof(ulong) * ARRAY_LENGTH(kmem_cache_s_cpudata),
		...
		BZERO(si->cpudata[i], sizeof(ulong) * vt->kmem_max_limit);
                ...
                readmem(cpudata[i]+LAZY_OFFSET(cpucache_s_avail),
...
gather_cpudata_list_v2(struct meminfo *si)
{
	...
	ulong shared;
		...
		BZERO(si->cpudata[i], sizeof(ulong) * vt->kmem_max_limit);
                ...
                readmem(cpudata[i]+LAZY_OFFSET(array_cache_avail),
                        KVADDR, &avail, sizeof(int),
	...
	BZERO(si->shared_array_cache, sizeof(ulong) * vt->kmem_max_limit);
	    ...
	    "kmem_list3 shared", RETURN_ON_ERROR|QUIET) ||
	    !readmem(shared+LAZY_OFFSET(array_cache_avail),
...
gather_cpudata_list_v2_nodes(struct meminfo *si, int index)
{
	...
	if (vt->flags & SLAB_CPU_CACHE) {
		readmem(si->cache+LAZY_OFFSET(kmem_cache_cpu_cache), KVADDR, 
	...
	if (!readmem(kmem_cache_nodelists(si->cache), KVADDR, &start_address[0], 
	    ...
	    !readmem(shared + LAZY_OFFSET(array_cache_avail), KVADDR, &avail, sizeof(int), 
...
address_space_start(struct task_context *tc, ulong *addr)
{
	...
	if (INVALID_MEMBER_LAZY(mm_struct_mmap) && VALID_MEMBER_LAZY(mm_struct_mm_mt)) {
		mm_mt = tc->mm_struct + LAZY_OFFSET(mm_struct_mm_mt);
		entry_num = do_maple_tree(mm_mt, MAPLE_TREE_COUNT, NULL);
		entry_list = (struct list_pair *)GETBUF(entry_num * sizeof(struct list_pair));
		do_maple_tree(mm_mt, MAPLE_TREE_GATHER, entry_list);
		for (i = 0; i < entry_num; i++) {
		...
		vma = ULONG(tt->mm_struct + LAZY_OFFSET(mm_struct_mmap));
	}

        if (!vma)
                return FALSE;
	vma_buf = fill_vma_cache(vma);
        *addr = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_start));
...
check_vma(ulong vma, ulong vaddr, ulong *vm_next, ulong *nextvaddr)
{
	...
	vm_start = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_start));
	vm_end = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_end));
	if (vm_next)
		*vm_next = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_next));
...
next_upage(struct task_context *tc, ulong vaddr, ulong *nextvaddr)
{
	...
	total_vm = ULONG(tt->mm_struct + LAZY_OFFSET(mm_struct_total_vm));
	if (!total_vm)
		return FALSE;
	...
	*nr_total_pages = *nr_total_free_pages = 0;
	if (kernel_symbol_exists("hstates")) {
		...
		for (i = 0; i < len; i++) {
			...
			readmem(vaddr + LAZY_OFFSET(hstate_order),
			...
			readmem(vaddr + LAZY_OFFSET(hstate_nr_huge_pages),
				KVADDR, &nr_huge_pages, sizeof(ulong),
				"hstate_nr_huge_pages", FAULT_ON_ERROR);

			readmem(vaddr + LAZY_OFFSET(hstate_free_huge_pages),
...
dump_swap_info(ulong swapflags, ulong *totalswap_pages, ulong *totalused_pages)
{
	...
	for (i = 0; i < vt->nr_swapfiles; i++, 
			...
			LAZY_OFFSET(swap_info_struct_swap_file));
                ...
                swap_device = INT(vt->swap_info_struct +
                        OFFSET_OPTION_DIRECT(
							get_lazy_offset(swap_info_struct_swap_device), 
							get_lazy_offset(swap_info_struct_old_block_size))
						);
		...
		if (VALID_MEMBER_LAZY(swap_info_struct_inuse_pages)) {
	...
	swap_file = ULONG(vt->swap_info_struct + 
		...
		if (VALID_MEMBER_LAZY(swap_info_struct_swap_vfsmnt)) {
			vfsmnt = ULONG(vt->swap_info_struct + 
                ...
                } else if (VALID_MEMBER_LAZY(swap_info_struct_old_block_size)) {
			devname = vfsmount_devname(file_to_vfsmnt(swap_file),
				buf1, BUFSIZE);
			get_pathname(file_to_dentry(swap_file),
				buf, BUFSIZE, 1, file_to_vfsmnt(swap_file));
...
vma_file_offset(ulong vma, ulong vaddr, char *buf)
{
	...
	if (!vma)
        ...
        vm_file = ULONG(vma_buf + LAZY_OFFSET(vm_area_struct_vm_file));
	...
	if (VALID_MEMBER_LAZY(vm_area_struct_vm_offset)) 
        	vm_offset = ULONG(vma_buf + 
			LAZY_OFFSET(vm_area_struct_vm_offset));
	else if (VALID_MEMBER_LAZY(vm_area_struct_vm_pgoff))
...
dump_memory_nodes(int initialize)
{
	...
	if (initialize) {
		...
		if (symbol_exists("pgdat_list") && 
		    (VALID_MEMBER_LAZY(pglist_data_node_next) || 
		     VALID_MEMBER_LAZY(pglist_data_pgdat_next))) {
                        get_symbol_data("pgdat_list", sizeof(void *), &pgdat);
			vt->flags &= ~NODES_ONLINE;
	...
	for (n = 0, badaddr = FALSE; pgdat; n++) {
		...
		readmem(pgdat+LAZY_OFFSET(pglist_data_node_id), KVADDR, &id,
			sizeof(int), "pglist node_id", FAULT_ON_ERROR);

		if (VALID_MEMBER_LAZY(pglist_data_node_mem_map)) {
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_mem_map), KVADDR, 
		...
		if (VALID_MEMBER_LAZY(pglist_data_node_start_paddr)) {
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_start_paddr), 
				KVADDR, &temp_node_start_paddr, sizeof(ulong), 
				"pglist node_start_paddr", FAULT_ON_ERROR);
			node_start_paddr = temp_node_start_paddr;
		}
		else if (VALID_MEMBER_LAZY(pglist_data_node_start_pfn)) {
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_start_pfn), 
		...
		if (VALID_MEMBER_LAZY(pglist_data_node_start_mapnr))
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_start_mapnr), 
				KVADDR, &node_start_mapnr, sizeof(ulong), 
				"pglist node_start_mapnr", FAULT_ON_ERROR);

		if (VALID_MEMBER_LAZY(pglist_data_node_size)) 
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_size), 
				KVADDR, &node_size, sizeof(ulong), 
				"pglist node_size", FAULT_ON_ERROR);
		else if (VALID_MEMBER_LAZY(pglist_data_node_spanned_pages)) {
			readmem(pgdat+LAZY_OFFSET(pglist_data_node_spanned_pages), 
		...
		if (VALID_MEMBER_LAZY(pglist_data_node_present_pages))
                        readmem(pgdat+LAZY_OFFSET(pglist_data_node_present_pages),
                                KVADDR, &node_present_pages, sizeof(ulong),
                                "pglist node_present_pages", FAULT_ON_ERROR);
		else
			node_present_pages = 0;

		if (VALID_MEMBER_LAZY(pglist_data_bdata))
			readmem(pgdat+LAZY_OFFSET(pglist_data_bdata), KVADDR, &bdata,
		...
		if (initialize) {
			nt->node_id = id;
			nt->pgdat = pgdat;
			if (VALID_MEMBER_LAZY(zone_struct_memsize)) 
		...
		if (!initialize) {
			...
			node_zones = pgdat + LAZY_OFFSET(pglist_data_node_zones);
		...
		for (i = 0; i < vt->nr_zones; i++) {
			...
			if (VALID_MEMBER_LAZY(zone_struct_size))
                		readmem(node_zones+LAZY_OFFSET(zone_struct_size), 
				    	KVADDR, &zone_size, sizeof(ulong),
                        		"zone_struct size", FAULT_ON_ERROR);
			else if (VALID_MEMBER_LAZY(zone_struct_memsize)) {
                		readmem(node_zones+LAZY_OFFSET(zone_struct_memsize), 
				    	KVADDR, &zone_size, sizeof(ulong),
                        		"zone_struct memsize", FAULT_ON_ERROR);
				nt->size += zone_size;
			} else if (VALID_MEMBER_LAZY(zone_spanned_pages)) {
                		readmem(node_zones+ LAZY_OFFSET(zone_spanned_pages), 
				    	KVADDR, &zone_size, sizeof(ulong),
			    ...
			    "zone_struct has neither size nor memsize field\n");
                	...
                	readmem(node_zones+ 
				OFFSET_OPTION_DIRECT(
					get_lazy_offset(zone_struct_free_pages),
					offset_table.zone_free_pages), KVADDR, &free_pages, 
				sizeof(ulong), "zone[_struct] free_pages", 
				FAULT_ON_ERROR);
                	readmem(node_zones+
							OFFSET_OPTION_DIRECT(
								get_lazy_offset(zone_struct_name),
								get_lazy_offset(zone_name)
								), KVADDR, &value, sizeof(void *),
                        	"zone[_struct] name", FAULT_ON_ERROR);
                	if (!read_string(value, buf1, BUFSIZE-1))
                        	sprintf(buf1, "(unknown) ");
			if (VALID_STRUCT(zone_struct)) {
				if (VALID_MEMBER_LAZY(zone_struct_zone_start_paddr))
				{
                        		readmem(node_zones+
				...
				if (IS_SPARSEMEM()) {
				    ...
				    INVALID_MEMBER_LAZY(zone_zone_mem_map)) {
					readmem(pgdat+LAZY_OFFSET(pglist_data_node_mem_map),
			...
			if (IS_SPARSEMEM()) {
			    ...
			    INVALID_MEMBER_LAZY(zone_struct_zone_mem_map) &&
			    INVALID_MEMBER_LAZY(zone_zone_mem_map)) {
                		readmem(pgdat+LAZY_OFFSET(pglist_data_node_mem_map),
				    KVADDR, &zone_mem_map, sizeof(void *), 
				    "contig_page_data mem_map", FAULT_ON_ERROR);
				...
				readmem(node_zones+
				    OFFSET_OPTION_DIRECT(
						get_lazy_offset(zone_struct_zone_mem_map),
						get_lazy_offset(zone_zone_mem_map)
						), KVADDR, &zone_mem_map, 
	...
	vm_stat_init();
        ...
        for (n = 0; pgdat; n++) {
			...
			if (VALID_MEMBER(zone_watermark)) {
				...
				value2 = ULONG(zonebuf + OFFSET_OPTION_DIRECT(
							get_lazy_offset(zone_pages_min),
							get_lazy_offset(zone_struct_pages_min))
						);
				value3 = ULONG(zonebuf + OFFSET_OPTION_DIRECT(
							get_lazy_offset(zone_pages_low),
							get_lazy_offset(zone_struct_pages_low))
						);
				value4 = ULONG(zonebuf + OFFSET_OPTION_DIRECT(
							get_lazy_offset(zone_pages_high),
							get_lazy_offset(zone_struct_pages_high))
						);
			}
			value5 = ULONG(zonebuf + OFFSET_OPTION_DIRECT(
						offset_table.zone_free_pages,
						get_lazy_offset(zone_struct_free_pages)));
			...
			if (VALID_MEMBER_LAZY(zone_vm_stat)) 
			    	dump_vm_stat("NR_FREE_PAGES", (long *)&value5, 
			    		node_zones + LAZY_OFFSET(zone_vm_stat));

			if (VALID_MEMBER_LAZY(zone_nr_active) && 
			    VALID_MEMBER_LAZY(zone_nr_inactive)) {
				value1 = ULONG(zonebuf + 
			...
			} else if (VALID_MEMBER_LAZY(zone_vm_stat) &&
			...
			if (VALID_MEMBER_LAZY(zone_all_unreclaimable)) {
				ivalue = UINT(zonebuf + 
					LAZY_OFFSET(zone_all_unreclaimable));
				fprintf(fp, "  ALL_UNRECLAIMABLE: %s  ", 
					ivalue ? "yes" : "no");
			} else if (VALID_MEMBER_LAZY(zone_flags) &&
				enumerator_value("ZONE_ALL_UNRECLAIMABLE", 
				(long *)&value1)) {
				value2 = ULONG(zonebuf + LAZY_OFFSET(zone_flags));
				value3 = value2 & (1 << value1);
				fprintf(fp, "  ALL_UNRECLAIMABLE: %s  ", 
					value3 ? "yes" : "no");
			}

			if (VALID_MEMBER_LAZY(zone_pages_scanned)) {
				value1 = ULONG(zonebuf + 
...
node_table_init(void)
{
	 ...
	 */
	if ((vt->flags & NODES) && (VALID_MEMBER_LAZY(pglist_data_node_next) || 
	    VALID_MEMBER_LAZY(pglist_data_pgdat_next))) {
...
first_vmalloc_address(void)
{
	...
	if (vt->flags & USE_VMAP_AREA) {
		...
		if (!vmap_area)
			return 0;
		if (!readmem(vmap_area - LAZY_OFFSET(vmap_area_list) +
		    LAZY_OFFSET(vmap_area_va_start), KVADDR, &vmalloc_start, 
		...
		if (!vm_struct)
			return 0;
		if (!readmem(vm_struct+LAZY_OFFSET(vm_struct_addr), KVADDR, 
...
l1_cache_size(void)
{
	...
	if (VALID_MEMBER_LAZY(kmem_cache_s_c_align)) {
        	cache = symbol_value("cache_cache");
                readmem(cache+LAZY_OFFSET(kmem_cache_s_c_align),
...
fill_memory_block_state(ulong memblock, char *buf)
{
	...
	readmem(memblock + LAZY_OFFSET(memory_block_state), KVADDR, &state,
...
fill_memory_block_name(ulong memblock, char *name)
{
	...
	kobj = memblock + LAZY_OFFSET(memory_block_dev) + LAZY_OFFSET(device_kobj);
...
print_memory_block(ulong memory_block)
{
	...
	readmem(memory_block + LAZY_OFFSET(memory_block_start_section_nr), KVADDR,
	...
	if (symbol_exists("memory_block_size_probed")) {
		...
		end_addr = start_addr + mbs - 1;
	        ...
	        readmem(memory_block + LAZY_OFFSET(memory_block_end_section_nr), KVADDR,
	...
	if (MEMBER_EXISTS("memory_block", "nid")) {
		readmem(memory_block + LAZY_OFFSET(memory_block_nid), KVADDR, &nid,
...
init_memory_block(int *klistcnt, ulong **klistbuf)
{
	...
	if (INVALID_MEMBER_LAZY(bus_type_p))
		...
		readmem(memory_subsys + LAZY_OFFSET(bus_type_p), KVADDR, &private,
	...
	klist = private + LAZY_OFFSET(subsys_private_klist_devices) +
	...
	ld->start = start;
	ld->end = klist;
	ld->list_head_offset = LAZY_OFFSET(klist_node_n_node) +
...
dump_memory_blocks(int initialize)
{
	...
	for (i = 0; i < klistcnt; i++) {
		readmem(klistbuf[i] + LAZY_OFFSET(device_private_device), KVADDR,
			&device, sizeof(void *), "device_private device",
			FAULT_ON_ERROR);
		memory_block = device - LAZY_OFFSET(memory_block_dev);
...
kmem_cache_list_common(struct meminfo *mi)
{
	...
	if (mi->flags & GET_SLAB_ROOT_CACHES)
		...
		cnt = get_kmem_cache_list_(&cache_list);

	for (i = 0; i < cnt; i++) {
		fprintf(fp, "%lx ", cache_list[i]);

		readmem(cache_list[i] + LAZY_OFFSET(kmem_cache_name), 
...
dump_kmem_cache_slub(struct meminfo *si)
{
	...
	if (INVALID_MEMBER_LAZY(kmem_cache_node_nr_slabs)) {
		error(INFO, 
	...
	if (si->flags & GET_SLAB_ROOT_CACHES)
		...
		si->cache_count = get_kmem_cache_list_(&si->cache_list);
	...
	for (i = 0; i < si->cache_count; i++) {
		...
		name = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_name)); 
		if (!read_string(name, buf, BUFSIZE-1))
			sprintf(buf, "(unknown)");
		if (reqname) {
		...
		size = UINT(si->cache_buf + LAZY_OFFSET(kmem_cache_size)); 
		offset = UINT(si->cache_buf + LAZY_OFFSET(kmem_cache_offset));
		if (VALID_MEMBER_LAZY(kmem_cache_objects)) {
			objects = UINT(si->cache_buf + 
				LAZY_OFFSET(kmem_cache_objects)); 
			order = UINT(si->cache_buf + LAZY_OFFSET(kmem_cache_order)); 
		} else if (VALID_MEMBER_LAZY(kmem_cache_oo)) {
			oo = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_oo));
		...
		si->random = VALID_MEMBER_LAZY(kmem_cache_random) ?
			ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_random)) : 0;
		...
		if (si->flags & GET_SLAB_ROOT_CACHES) {
			...
			for (j = 0; j < mi->cache_count; j++) {
				...
				name = ULONG(mi->cache_buf + LAZY_OFFSET(kmem_cache_name));
				if (!read_string(name, buf2, BUFSIZE-1))
					sprintf(buf2, "(unknown)");

				objsize = UINT(mi->cache_buf + OFFSET(kmem_cache_objsize));
				size = UINT(mi->cache_buf + LAZY_OFFSET(kmem_cache_size));
				offset = UINT(mi->cache_buf + LAZY_OFFSET(kmem_cache_offset));
				if (VALID_MEMBER_LAZY(kmem_cache_objects)) {
					objects = UINT(mi->cache_buf +
						LAZY_OFFSET(kmem_cache_objects));
					order = UINT(mi->cache_buf + LAZY_OFFSET(kmem_cache_order));
				} else if (VALID_MEMBER_LAZY(kmem_cache_oo)) {
					oo = ULONG(mi->cache_buf + LAZY_OFFSET(kmem_cache_oo));
					objects = oo_objects(oo);
					order = oo_order(oo);
				} else
					error(FATAL, "cannot determine "
				...
				mi->random = VALID_MEMBER_LAZY(kmem_cache_random) ?
					ULONG(mi->cache_buf + LAZY_OFFSET(kmem_cache_random)) : 0;
...
count_cpu_partial(struct meminfo *si, int cpu)
{
	...
	if (VALID_MEMBER_LAZY(kmem_cache_cpu_partial) && VALID_MEMBER(page_objects)) {
		readmem(ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_cpu_slab)) +
			kt->__per_cpu_offset[cpu] + LAZY_OFFSET(kmem_cache_cpu_partial),
...
get_kmem_cache_slub_data(long cmd, struct meminfo *si)
{
	...
	node_total_avail = VALID_MEMBER_LAZY(kmem_cache_node_total_objects) ? TRUE : FALSE;
	...
	for (n = 0; n < vt->numnodes; n++) {
		...
		if (!node_ptr) 
			continue; 
               	...
               	if (!readmem(node_ptr + LAZY_OFFSET(kmem_cache_node_nr_partial), 
		    KVADDR, &node_nr_partial, sizeof(ulong), 
		    "kmem_cache_node nr_partial", RETURN_ON_ERROR))
			goto bailout;
               	if (!readmem(node_ptr + LAZY_OFFSET(kmem_cache_node_nr_slabs), 
		    KVADDR, &node_nr_slabs, sizeof(ulong), 
		    "kmem_cache_node nr_slabs", RETURN_ON_ERROR))
			goto bailout;
		if (node_total_avail) {
			if (!readmem(node_ptr + LAZY_OFFSET(kmem_cache_node_total_objects),
...
do_cpu_partial_slub(struct meminfo *si, int cpu)
{
	...
	cpu_slab_ptr = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_cpu_slab)) +
				kt->__per_cpu_offset[cpu];
	readmem(cpu_slab_ptr + LAZY_OFFSET(kmem_cache_cpu_partial), KVADDR,
...
do_kmem_cache_slub(struct meminfo *si)  
{
	...
	per_cpu = (ulong *)GETBUF(sizeof(ulong) * vt->numnodes);
		...
		if (VALID_MEMBER_LAZY(kmem_cache_cpu_partial))
...
#define PAGE_MAPPING_ANON  1
	...
	red_left_pad = 0;
	if (VALID_MEMBER_LAZY(kmem_cache_red_left_pad)) {
		flags = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_flags));
		if (flags & SLAB_RED_ZONE)
			red_left_pad = ULONG(si->cache_buf + LAZY_OFFSET(kmem_cache_red_left_pad));
	}
...
do_node_lists_slub(struct meminfo *si, ulong node_ptr, int node)
{
	...
	list_head = node_ptr + LAZY_OFFSET(kmem_cache_node_partial);
...
#define SLAB_STORE_USER (0x00010000UL)
	...
	if (INVALID_MEMBER_LAZY(kmem_cache_node_full) ||
	    !(flags & SLAB_STORE_USER)) {
		fprintf(fp, "NODE %d FULL:\n  (not tracked)\n", node);
		return;
	}

	list_head = node_ptr + LAZY_OFFSET(kmem_cache_node_full);
 	if (!readmem(list_head, KVADDR, &next, sizeof(ulong),
...
is_kmem_cache_addr_common(ulong vaddr, char *kbuf)
{
		...
		if (!readmem(cache_list[i] + LAZY_OFFSET(kmem_cache_name), 
		    KVADDR, &name, sizeof(char *),
 ...
 */
static int
get_kmem_cache_list_(ulong **cache_buf)
{
	int cnt;
	ulong vaddr;
	struct list_data list_data, *ld;
	...
	ld->flags |= LIST_ALLOCATE;
	ld->start = vaddr;
	ld->list_head_offset = LAZY_OFFSET(kmem_cache_list);
...
get_kmem_cache_root_list(ulong **cache_buf)
{
	...
	ld->flags |= LIST_ALLOCATE;
	ld->start = vaddr;
	ld->list_head_offset = LAZY_OFFSET(kmem_cache_memcg_params)
...
get_kmem_cache_child_list(ulong **cache_buf, ulong root)
{
	...
	children = root + LAZY_OFFSET(kmem_cache_memcg_params)
...
compound_head(ulong page)
{
	...
	} else if (readmem(page+LAZY_OFFSET(page_flags), KVADDR, &flags, sizeof(ulong),
...
count_partial(ulong node, struct meminfo *si, ulong *free)
{
	...
	count = 0;
	total_inuse = 0;
	list_head = node + LAZY_OFFSET(kmem_cache_node_partial);
	if (!readmem(list_head, KVADDR, &next, sizeof(ulong),
	    "kmem_cache_node.partial", RETURN_ON_ERROR))
		return -1;
...
get_cpu_slab_ptr(struct meminfo *si, int cpu, ulong *cpu_freelist)
{
	...
	case TYPE_CODE_STRUCT:
		...
		if (cpu_freelist && VALID_MEMBER_LAZY(kmem_cache_cpu_freelist))
	...
	case TYPE_CODE_ARRAY:
		cpu_slab_ptr = ULONG(si->cache_buf +
			LAZY_OFFSET(kmem_cache_cpu_slab) + (sizeof(void *)*cpu));

		if (cpu_slab_ptr && cpu_freelist &&
		    VALID_MEMBER_LAZY(kmem_cache_cpu_freelist)) {
			if (readmem(cpu_slab_ptr + LAZY_OFFSET(kmem_cache_cpu_freelist),
...
slab_to_kmem_cache_node(struct meminfo *si, ulong slab_page)
{
	...
	if (vt->flags & CONFIG_NUMA) {
		...
		node_ptr = si->cache + LAZY_OFFSET(kmem_cache_local_node);
